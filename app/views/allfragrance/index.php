...
// require_once('/opt/lampp/htdocs/perfumesite/mvcshop/app/views/layouts/navbar.php');
require_once('/opt/lampp/htdocs/perfumesite/mvcshop/app/views/layouts/header.php');
require_once('/opt/lampp/htdocs/perfumesite/mvcshop/app/views/layouts/navbar.php');
require_once('/opt/lampp/htdocs/perfumesite/mvcshop/app/views/layouts/sidebar.php');
        ...
        <div class="w-full border  border-1 rounded-md relative p-3 product-item">
            <a href="">
                <div class="w-full h-[250px] bg-gray-100">
                    <img src="" alt="" class="object-fit w-full h-full">
                </div>
                ...
                <div
                    class="tiny-box- absolute top-[45%] left-[0%] z-30 bg-black text-white text-xs p-1 rounded-md hidden">
                    Copied!
                </div>
                            ...
                            <div>
                                <div
                                    ...
                                    <form action="" id="add_form" method="POST"
                                        ...
                                        <input type="hidden" name="addtowish_itemid" value="">
                                    </form>
                                </div>
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <form action="" id="add_form" method="POST"
                                        ...
                                        <input type="hidden" name="singlebrand" value="">
                                        <input type="hidden" name="singleprice" value="">
                                        <input type="hidden" name="singlequantity" value="1">


                                        <!-- for cookie  -->
                                        <input type="hidden" name="single_ck_img" value="">
                                        <input type="hidden" name="single_ck_name" value="">
                                        <input type="hidden" name="single_ck_brand" value="">
