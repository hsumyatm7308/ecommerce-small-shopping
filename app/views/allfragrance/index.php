<?php
    ...
    require_once ('/Applications/XAMPP/htdocs/perfumesite/mvcshop/app/views/layouts/navbar.php');
    require_once ('/Applications/XAMPP/htdocs/perfumesite/mvcshop/app/views/layouts/sidebar.php');
