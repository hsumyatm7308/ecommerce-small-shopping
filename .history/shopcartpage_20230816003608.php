...
<body>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            // This part finds the container element with the class 'itemscontainer'
            var itemscontainer = document.querySelector('.itemscontainer');

            // Get the count of child elements within the 'itemscontainer'
            var itemscount = itemscontainer.childElementCount;

            // Use AJAX to send the itemscount value to the server
            $.ajax({
                url: "headersection.php",
                method: 'POST',
                data: { itemscount: itemscount }, // Sending the itemscount value as POST data
                success: function (data) {
                    console.log('Data sent successfully:', data);
                    // You can perform actions here after the successful AJAX request
                    // For example, you might update UI elements based on the response.
                },
            });
        });
