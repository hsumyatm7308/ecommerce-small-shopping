        ...
        <nav class="w-screen h-auto  flex items-center grid grid-cols-4 p-3">
            ...
            <div class="h-full  flex justify-center items-center flex-col relative mt-5">
                ...
                <div class="w-[82%] bg-gray-100 flex justify-start items-center flex-col absolute top-12 mt-1 result">
                    <span class="w-[82%] self-start ml-5 mb-1 p-3 border border-t-transparent border-b-gray-200">adfs</span>
                    <span class="w-[82%] self-start ml-5 mb-1 p-3 border border-b-gray-200">adfs</span>
                </div>
            </div>
            <!-- </form> -->
