                ...
                <div class="w-[100%] grid grid-cols-3">
                    ...
                    <div class="col-spans-1 flex justify-center items-center mr-5">
                        <p class="font-semibold">
                            ...
                            // Make sure the form containing the hidden input field is submitted to this PHP script.
                            if ($_SERVER["REQUEST_METHOD"] === "POST") {
                                // Retrieve the 'subtotal' value from the POST request.
                                $subtotal = $_POST["subtotal"];

                                // Now you can use $subtotal in your PHP code.
                            }

                            $subtotal = intval($cost['shipcost']) + intval($_SESSION['subtotal']);
                            echo $subtotal;
                            ?>
                        </p>
                    </div>
...
<input type="hidden" id="subtotal" name="subtotal" value="your_subtotal_value_here">
<script>
