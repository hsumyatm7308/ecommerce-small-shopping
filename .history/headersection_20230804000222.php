    ...
    <header class="">
        ...
        <nav class="w-screen h-auto  flex items-center grid grid-cols-4 p-3">
            ...
            <div class="h-full  flex justify-center items-center flex-col relative mt-5">
                ...
                <div class="w-[82%] bg-gray-100 rounded-b-lg flex justify-start items-center flex-col absolute top-12 mt-1 result">
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#search').keyup(function(){
            ...
            $.post("searchfunction/search.php",{d:query} function($searchstmt){
