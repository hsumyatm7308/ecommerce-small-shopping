            ...
            <div class="flex justify-start items-center">
                <ul class="flex justify-start items-center text-[15px] uppercase">
                    ...
                    if (!empty($currentPage)) {
                        ...
                        echo '<li class="mr-5 hover:bg-gray-100"><a href="index.php?page=1">All</a></li>';
                    ...
                    if (!empty($currentMenPage)) {
                        ...
                        echo '<li class="mr-5 hover:bg-gray-100"><a href="menfrg.php?menpage=1">Men</a></li>';
                    }

                    if (!empty($currentWomenPage)) {
                        echo '<li class="mr-5 border border-stone-300 px-2 py-2 rounded-full hover:bg-gray-100 hover:px-2 hover:py-2"><a href="womenfrg.php?womenpage=1">Women</a></li>';
                    } else {
                        echo '<li class="mr-5 hover:bg-gray-100"><a href="womenfrg.php?womenpage=1">Women</a></li>';
                    }
                    ?>
                </ul>
            </div>
