                        ...
                        <?php while ($row = $stmt->fetch()): ?>
                            ...
                            <div id="<?= $row['perfume_id'] ?>"
                                ...
                                <section>
                                    <div class="">
                                        <div
                                            class="modal w-full h-screen bg-[linear-gradient(rgba(0,0,0,.2),rgba(0,0,0,.2))] flex justify-center items-center fixed left-0 top-0 z-[100]">
                                            <!-- Modal content  -->
                                            <div
                                                ...
                                                <div class='mt-6'>
                                                    <button
                                                        class="bg-gray-400 border rounded-md px-5 py-1 m-1 hover:opacity-80 hover:text-white focus:ring-1">Okay</button>
                                                    <button
                                                        class="border-2 border-indigo-100 rounded-md px-5 py-1 m-1 hover:border-indigo-200 focus:ring-1">Cancle</button>
                                                </div>
                                            </div>
