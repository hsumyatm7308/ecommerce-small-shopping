                    ...
                    <div class="w-[90%] mt-10">
                        ...
                        if (!empty($_SESSION['cart'])) {
                            ...
                            <a href="shopcartpage.php?action=remove&id=' . $value['id'] . '" >
                                     ...
                                     <button class=" px-3 py-1 bg-gray-100 remove-item" name="remove" >Remove</button>
...
<!-- Your HTML form and buttons here -->
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        async function addToCart(itemId) {
            // You can use AJAX here to send the item ID to the server and update the cart
            // For simplicity, let's assume the server has already updated the cart session
            // using the provided PHP code
        }
        ...
        function updateURL(itemId) {
            ...
            urlParams.delete('id'); // Remove all existing id parameters
