...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    if (isset($_POST['action']) && $_POST['action'] === 'update') {
        ...
        $checkstmt = $conn->prepare("SELECT perfumeprice FROM addtocart WHERE temporaryid = :id");
        ...
        $updatestmt = $conn->prepare("UPDATE addtocart SET quantity = :qty, totalprice = :priceval WHERE temporaryid = :id");
