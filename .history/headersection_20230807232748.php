        ...
        <nav class="w-screen h-auto  flex items-center grid grid-cols-4 p-3">
            ...
            <div class="flex justify-start items-center">
                <ul class="flex justify-start items-center text-[15px] uppercase cursor-pointer">
                    ...
                    if (!empty($currentPage)) {
                        echo '<li class="mr-5 border border-stone-300 px-2 py-2 rounded-full hover:bg-gray-100"><a href="ecommerce/index.php?page=1?page=1">All</a></li>';

                    } else {
                        echo '<li class="mr-5 px-2 py-2 hover:border hover:border-stone-100 hover:rounded-full"><a href="ecommerce/index.php?page=1?page=1">All</a></li>';
            ...
            <div class="flex justify-center items-center p-3">
                ...
                <div class="flex justify-center items-center">
                    ...
                    <span class="ml-3 cursor-pointer">Bag</span>
                </div>
            </div>
