...
<body>
                        ...
                        try {
                            ...
                            if ($_SERVER['REQUEST_METHOD'] === "POST") {
                                if (isset($_POST['action']) && $_POST['action'] === 'del') {
                                    ...
                                    // Echo a response to indicate success
                                    echo 'Item deleted successfully' . $id;
                                }
                            }
                            ...
                            <div id="<?= $row['perfume_id'] ?>"
                                ...
                                <div class="flex justify-center items-center">
                                    <button type="submit" name="" id="removebtn-<?= $row['perfume_id'] ?>"
                                        class="px-3 py-1 bg-gray-400 rounded-md shadow removebtn hover:text-white"
                                                        ...
                                                        <div class="flex justify-center items-center">
                                                            <div class="flex justify-center items-center">
                                                                <button type="submit" name="name"
                                                                    ...
                                                                    data-item-id="<?= $row['perfume_id'] ?>">Delete</button>
                                                            </div>
                                                        </div>
                                                    </form>

                                                    <!-- <button name="remove"
                                                        class="border-2 border-indigo-100 rounded-md px-5 py-1 m-1 hover:border-indigo-200 focus:ring-1 ">Remove</button> -->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            const removeParam = urlParams.get('remove');
            ...
            for (var i = 0; i < removebtn.length; i++) {
                (function (index) {
                    $(removebtn[index]).click(function () {
                        ...
                        var id = $(removebtn[index]).data('item-id');
                        console.log(id);
