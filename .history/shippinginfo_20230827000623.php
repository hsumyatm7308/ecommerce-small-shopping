                    ...
                    <div class="w-full min-h-[500px] flex justify-center items-center flex-col">
                        ...
                        <form action="" method="post" class="w-[80%]">
                            ...
                            <div class="w-full">
                                ...
                                <div class="w-full border  p-5 guestinfo">
                                    <div class="w-full bg-gray-100 mb-3">
                                        <!-- <h1 class="p-2">Customer</h1> -->
                                    </div>
                                  

                                    <div class="w border-b inputval mb-2">
                                        <label for="">First Name</label>
                                        <input type="text" name="firstname"
                                            class="w-full focus:outline-none p-4 val" placeholder="">
                                    </div>

                                    <div class="w-full border-b inputval mb-2">
                                        <input type="text" name="lastname"
                                            class="w-full focus:outline-none p-4 val" placeholder="Last Name">
                                    </div>
                                   

                                    <div class="w-full border-b inputval mb-2">
                                        <input type="text" name="company"
                                            class="w-full focus:outline-none p-4 val" placeholder="Company (Option)">
                                    </div>

                                    
                                    <div class="w-full border-b inputval mb-2">
                                        <input type="text" name="phone"
                                            class="w-full focus:outline-none p-4 val" placeholder="Phone Number (Option)">
                                    </div>
                                    ...
                                    <div class="w-full border-b inputval mb-2">
                                        <input type="text" name="city"
                                            class="w-full focus:outline-none p-4 val" placeholder="City">
                                    </div>
