                        ...
                        <div class="w-[85%] flex items-center flex-col mt-3">
                            ...
                            <?php while ($row = $stmt->fetch()): ?>
                              <?php 
                                ...
                                // $totalamount += $subtotal;
                              ?>
                                <li  class="w-full flex justify-between mb-2"><span> <?php$row['perfumename'] ?> </span>  <input type="text" id="totallist-<?php$row['perfume_id'] ?>"
                                class="w-20 p-1 focus:outline-none totalprice" value="$<?php $row['totalprice'] ?>"
                                readonly></li>';
