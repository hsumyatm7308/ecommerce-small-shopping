...
<div class="flex justify-center items-center mt-10 p-10">
    ...
    if (isset($_GET['search'])) {
        ...
        if ($currentPricePage > 1) {
            ...
            echo '<a href="?page&startprice=' . $startprice . '&endprice=' . $endprice . '&price=' . $prevPricePage . '" class="text-red-500 border px-2 py-1 mr-10">Prev</a>';
        }

        for ($x = 1; $x <= $totalpages; $x++) {
            echo '<a href="?page&startprice=' . $startprice . '&endprice=' . $endprice . '&price=' . $x . '"  class="border px-2 py-1 m-1 flex justify-center items-center';
        ...
        if ($currentPricePage < $totalpages) {
            ...
            echo '<a href="?page&startprice=' . $startprice . '&endprice=' . $endprice . '&price=' . $nextPricePage . '" class="text-red-500 border px-2 py-1 ml-10">Next</a>';
        }
    } else {
        ...
        if (isset($_GET['type']) && $_GET['type'] === 'on') {
            if (isset($_GET['unisexquery']) && $_GET['unisexquery'] > 1) {
                ...
                echo '<a href="?page&type=on&unisexquery=' . $prevUnisexPage . '" class="text-red-500 border px-2 py-1 mr-10">Prev</a>';
            }

            for ($x = 1; $x <= $totalpages; $x++) {
                echo '<a href="?page&type=on&unisexquery=' . $x . '"  class="border px-2 py-1 m-1 flex justify-center items-center';
            ...
            if (isset($_GET['unisexquery'])) {
                if ($_GET['unisexquery'] >= $totalpages) {
                    ...
                    echo '<a href="?page&type=on&unisexquery=' . $nextPage . '" class="text-red-500 border px-2 py-1 ml-10">Next</a>';
                }
            } else {
            ...
            for ($x = 1; $x <= $totalpages; $x++) {
                echo '<a href="?page&type=mon&menquery=' . $x . '"  class="border px-2 py-1 m-1 flex justify-center items-center';
            ...
            if (isset($_GET['menquery'])) {
                if ($_GET['menquery'] >= $totalpages) {
                    ...
                    echo '<a href="?page&type=mon&menquery=' . $nextPage . '" class="text-red-500 border px-2 py-1 ml-10">Next</a>';
                }
            } else {
                echo '<a href="?page&type=mon&menquery=1" class="text-blue-500 border px-2 py-1 ml-10">Next</a>';
            }
        } elseif (isset($_GET['type']) && $_GET['type'] === 'fon') {
            if (isset($_GET['womenquery']) && $_GET['womenquery'] > 1) {
                $prevMenPage = $_GET['womenquery'] - 1;
                echo '<a href="?page&type=fon&womenquery=' . $prevMenPage . '" class="text-red-500 border px-2 py-1 mr-10">Prev</a>';
            }

            for ($x = 1; $x <= $totalpages; $x++) {
                echo '<a href="?page&type=fon&womenquery=' . $x . '" class="border px-2 py-1 m-1 flex justify-center items-center';
            ...
            if (isset($_GET['womenquery'])) {
                if ($_GET['womenquery'] >= $totalpages) {
                    ...
                    echo '<a href="?page&type=fon&womenquery=' . $nextPage . '" class="text-red-500 border px-2 py-1 ml-10">Next</a>';
                }
            } else {
                echo '<a href="?page&type=mon&menquery=1" class="text-blue-500 border px-2 py-1 ml-10">Next</a>';
            }
