...
try {
    ...
    if(isset($_GET['search'])){
        ...
        $searchstmt = $conn->prepare("SELECT id, perfume_name, brand_name, category_name, price, imgurl,mili FROM perfume WHERE perfume_name AND brand_name IN ('Men','Unisex','Women') ORDER BY $sortOption");
        $searchstmt->execute();
