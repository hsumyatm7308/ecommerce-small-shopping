...
<body>
                    ...
                    <div class="w-[90%] mt-10">
                        ...
                        <form action="shopcartpage.php" method="post">
                                ...
                                <div class="  flex justify-center items-center p-1">
                                   ...
                                   <div class="item flex justify-center items-center p-1">
                                        <div class="flex items-center">
                                            ...
                                            <span id="increase" name="increase" class="bg-gray-100 border px-2 py-1 m-1 increase">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                            ...
                            <div class="flex justify-center items-center">
                               ...
                               <input type="text" id="totalprice-' . $value['id'] . '" class="w-20 p-1 totalprice-' . $value['id'] . '" value="$' . number_format($value['quantity'] * $value['price'], 2) . '" readonly>
                            </div>
    ...
    <script>
        ...
        items.forEach(item => {
            ...
            const totalpriceinput = item.querySelector(".totalprice-<?= $value['id'] ?>");
