...
<body class="">
    ...
    <section>
        <div class="">
            <div class="modal w-full h-screen bg-[linear-gradient(rgba(0,0,0,.5),rgba(0,0,0,.5))] flex justify-center items-center absolute left-0 top-0">
                <!-- Modal content  -->
                <div class="w-[500px] h-[300px] bg-gray-400 rounded-md">
