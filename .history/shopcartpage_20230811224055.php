...
<body>
    ...
    <script>
        ...
        items.forEach(item => {
            ...
            const totalprice = item.getElementsByClassName('.totalprice');
    ...
    document.querySelectorAll('.remove-item').forEach(button => {
        button.addEventListener('click', function(event) {
            ...
            if (confirm('Are you sure you want to remove this item?')) {
                // Get the total price element associated with the clicked button's item
                const totalpriceId = 'totalprice-' + this.getAttribute('data-item-id');
                const totalpriceElement = document.getElementById(totalpriceId);

                // Get the value of the total price
                const totalpriceValue = totalpriceElement.value;

                // Submit the parent form when the user confirms removal
                this.closest('form').submit();
            }
        });
    });
</script>
In this code, I've added an ID to each total price element that is unique to the item. When the "Remove" button is clicked, the associated total price element is located using the ID and its value is retrieved. This value can then be used or processed as needed in your JavaScript code.
