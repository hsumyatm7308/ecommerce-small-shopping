...
<body class="">
                        ...
                        <?php while ($row = $stmt->fetch()): ?>
                            ...
                            <div id="<?= $row['perfume_id'] ?>"
                                ...
                                <button type="submit" name=""
                                    class="px-3 py-1 bg-gray-400 rounded-md shadow remove-item hover:text-white removebtn<?= $row['perfume_id'] ?>"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var removebtn = document.querySelector('.removebtn<?= json_encode($row['perfume_id']) ?>');
