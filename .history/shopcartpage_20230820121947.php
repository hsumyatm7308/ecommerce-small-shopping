        ...
        <div class="w-full p-8">
            <div class="grid grid-cols-3">
                                ...
                                <div class="flex justify-center items-center">
                                    <div class="flex justify-center items-center">
                                        <button type="submit" name="" id=""
                                            class="px-3 py-1 bg-gray-300 rounded-md shadow removeitem hover:text-white"
                ...
                <div class="w-full flex justify-start items-center flex-col">
                    ...
                    <div
                        class="w-[400px] h-16 bg-gray-400 flex justify-center items-center mt-10   border hover:border-2">
