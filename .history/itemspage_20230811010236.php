      ...
      <div>
        ...
        <div class="mr-10">
          ...
          if (isset($_GET['items'])) {
            ...
            if ($itemId === $row['id']) {
              echo <<<HTML
              <h1 class="text-3xl" data-perfume-name="<?php echo $row['perfume_name']; ?>" data-brand-name="<?php echo $row['brand_name']; ?>">{$row['perfume_name']} by {$row['brand_name']} EDT 3.3 OZ {$row['mili']} spray for {$row['category_name']}</h1>
  ...
  <script class="text/javascript">
    $(document).ready(function () {
      ...
      addtocartbtn.click(function () {
        ...
        var items = <?php echo $_GET['items']; ?>;
        var perfumename = <?php echo $row['perfume_name'] ?>
