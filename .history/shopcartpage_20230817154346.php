                            ...
                            <?php while ($row = $stmt->fetch()): ?>
                                ...
                                <script type="text/javascript">
                                    ...
                                    function updatesubtotal() {
                                        var subtotalist = 0; // Initialize subtotalist

                                        <?php while ($row = $stmt->fetch()): ?>
                                            var qty<?= $row['perfume_id'] ?> = parseInt(document.querySelector("#quantity-<?= $row['perfume_id'] ?>").value);
                                            var price<?= $row['perfume_id'] ?> = <?= $row['perfumeprice'] ?>;
                                            subtotalist += qty<?= $row['perfume_id'] ?> * price<?= $row['perfume_id'] ?>;
                                        <?php endwhile; ?>
