                        ...
                        <div class="w-[85%] flex items-center flex-col mt-3">
                            ...
                            <script>
                                ...
                                for (var i = 0; i < totalprice.length; i++) {
                                    ...
                                    var total = curqty * curpricevalue;

                                    subtotalist += total; // Add the total value to the subtotal here
                                }

                                console.log(subtotalist); // This will display the calculated subtotal
                            </script>
