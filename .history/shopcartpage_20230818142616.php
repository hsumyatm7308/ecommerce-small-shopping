                ...
                <div class="col-span-2 flex justify-center items-start">
                    ...
                    <div class="w-[90%] mt-10 itemscontainer">
                        ...
                        try {
                            ...
                            if (isset($_POST['remove'])) {
                                $id = $_POST['remove']; // Use $_POST here
                                $stmt = $conn->prepare('DELETE FROM addtocart WHERE perfume_id = :id');
                                $stmt->bindParam(':id', $id);
                                $stmt->execute();
                                // You can send a response back to indicate successful deletion if needed
                                                        ...
                                                        <div class="flex justify-center items-center">
                                                            <div class="flex justify-center items-center">
                                                                <!-- <button type="submit" name="remove"
                                                                    ...
                                                                    class="px-3 py-1 bg-gray-400 rounded-md shadow  hover:text-white"
                                                                    data-item-id="<?= $row['perfume_id'] ?>">Remove</button> -->

                                                                    <button type="submit" name="remove" id="" class="px-3 py-1 bg-gray-400 rounded-md shadow  hover:text-white">Okay</button>
                                                            </div>
                                                        </div>
                                                    </form>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.remove-item').click(function () {
                ...
                $.ajax({
                    url: './shopcartpage.php?remove=' + id,
                    method: "POST",
                    success: function (data) {
                        console.log('hielo'); // Fix the syntax error here ('hielo' instead of 'hielo';)
                        // You can also handle the response from the server here if needed
                    }
                });
            });
