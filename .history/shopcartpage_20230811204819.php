                ...
                <div class="col-span-2 flex justify-center items-start">
                    ...
                    <div class="w-[90%] mt-10">
                        ...
                        if (!empty($_SESSION['cart'])) {
                            ...
                            <div class="flex justify-center items-center">
                               <a href="#" class="remove-item" data-item-id="' . $value['id'] . '">Remove</a>
                            </div>
                             </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            removeLinks.forEach(link => {
                link.addEventListener('click', (event) => {
                    ...
                    removeItemFromSession(itemId)
                        .then(() => removeItemFromUI(itemId));
                });
            });

            async function removeItemFromSession(itemId) {
                const response = await fetch(`remove_item.php?action=remove&id=${itemId}`);
            ...
            function removeItemFromUI(itemId) {
                console.log('Removing UI for item:', itemId);
