...
<body>
                    ...
                    <div class="w-[90%] mt-10">
                        ...
                        if (!empty($_SESSION['cart'])) {
                            ...
                            <div class="flex justify-center items-center">
                                  ...
                                  <button class="px-3 py-1 bg-gray-100 remove-btn" name="deletebtn" onclick="deleteitem(' . $value['id'] . ')">Remove</button>
    ...
    <script>
        ...
        function deleteitem(id) {
                    ...
                    var itemId = $(this).data("id"); // Directly get data-id value
                    var removeUrl = "deleteitem.php?action=remove&id=" + itemId;
                    var currentItem = $(this).closest(".cart-item");
