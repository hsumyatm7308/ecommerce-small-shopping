                ...
                try {
                    ...
                    if ($temp_customer_id) {
                        ...
                        if ($rowCount > 0) {
                            ...
                            $insertStmt->bindParam(":lastname", $email);
                            $insertStmt->bindParam(":phone", $email);
                            $insertStmt->bindParam(":address", $email);
                            $insertStmt->bindParam(":city", $email);
                            $insertStmt->bindParam(":company", $email);
