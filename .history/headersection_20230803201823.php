    ...
    <header class="">
        ...
        <nav class="w-screen h-auto  flex items-center grid grid-cols-4 p-3">
            ...
            <div class="h-full  flex justify-center items-center flex-col relative mt-5">
                <div class="flex justify-center items-center bg-gray-200 rounded-lg py-2 pl-1 pr-5 searchbox">
                    <input type="search" name="search" id="search"
                        class=" bg-gray-200 ml-4 pr-9 focus:outline-none placeholder-[#01125f]  placeholder-opacity-75 active:transparent "
                        placeholder="Search...">
                    <button type="submit">
                ...
                <div class="w-[82%] bg-gray-200 flex justify-start items-center flex-col absolute top-12 mt-1 result">
                    <span class="w-[82%] self-start ml-5 mb-1 p-3 border border-b-gray-100">adfs</span>
                    <span class="w-[82%] self-start ml-5 mb-1 p-3 border border-b-gray-100">adfs</span>
                </div>
            </div>
            <!-- </form> -->
