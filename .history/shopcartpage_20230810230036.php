...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    // Check if the 'value' parameter is set in the POST request
    if (isset($_POST["value"])) {
        ...
        echo "Value received and processed: " . htmlspecialchars($value);
    } else {
        echo "Value parameter is missing in the request.";
    }
} else {
