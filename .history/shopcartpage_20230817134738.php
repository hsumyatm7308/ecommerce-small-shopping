                        ...
                        <?php while ($row = $stmt->fetch()): ?>
                            ...
                            <div id="<?= $row['perfume_id'] ?>"
                                ...
                                <script type="text/javascript">
                                    ...
                                    const totallist<?=$row['perfume_id']?> =document.querySelector("#totallist-<?=$row['perfume_id']?>");


                                    console.log(totallist<?=$row['perfume_id']?>.value)
                                    ...
                                    if (savedprice<?= $row['perfume_id'] ?> !== null) {
                                        ...
                                        // totallist<?=$row['perfume_id']?> .value = savedprice<?= $row['perfume_id'] ?>;
                                    }
                    ...
                    <div class="w-[400px] min-h-[300px] bg-gray-100 mt-10 flex  items-center flex-col px-5 py-7">
                        <div class="w-full h-10 bg-gray-200 flex justify-between items-center">
                            ...
                            try {
                                ...
                                echo '<h1 class="text-black mr-7">Subtotal: <span class="text-indigo-500 ml-2 totalmount">' . $totalamount . ' $</span></h1>';
                            ...
                            <script>
                                var totalmount = document.getElementsByClassName('.totalmount');
                        ...
                        <div class="w-[85%] flex items-center flex-col mt-3">
                            ...
                            try {
                                ...
                                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    // $totalamount += $subtotal;
                                    echo '<li  class="w-full flex justify-between mb-2"><span>' . $row['perfumename'] . '</span>  <input type="text" id="totallist-'.$row['perfume_id'].'"
                                    class="w-20 p-1 focus:outline-none totalprice" value="$'.$row['totalprice'] .'"
                                    readonly></li>';
