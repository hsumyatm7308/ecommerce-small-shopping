    ...
    <section>
        <div class="w-full p-8">
            <div class="grid grid-cols-3">
                ...
                <div class="w-full flex justify-start items-center flex-col">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === "POST") {
                        if (isset($_POST['checkout'])) {
                            ...
                            // Now you can use $qty in your PHP logic
                            echo "Checkout button clicked! Quantity: " . $qty;
                        }
                    }
                    ?>
                ...
                <script>
                    // Assuming you have stored the quantity in localStorage
                    var qty = localStorage.getItem('qty-<?= $row['perfume_id'] ?>');

                    // Send the quantity to the server using a form field or AJAX
                    // For simplicity, let's use a hidden input field within the form
