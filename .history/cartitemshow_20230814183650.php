...
<form action="" method="post">
    ...
    <div id="" class="cart-item grid grid-cols-6 justify-center items-center border-b mb-4">
        <!-- Your item details and HTML elements here -->
        ...
        <div class=" flex justify-center items-center">
            <div class="flex justify-center items-center p-1">
                <div class="item flex justify-center items-center p-1">
                    <div class="flex items-center">
                        <span id="decrease-<?= $row['id'] ?>" class="bg-gray-100 border px-2 py-1 m-1 decrease">
                            <!-- Decrease icon SVG here -->
                        </span>

                        <span class="w-8 h-8 bg-gray-100 text-[#000] font-semibold shadow drop-shadow-md flex justify-center items-center">
                            <input type="text" class="w-8 bg-gray-100 focus:outline-none valueinput" name="quantity" value="<?= $row['quantity'] ?>" style="text-align:center;">
                        </span>

                        <button type="submit" name="increase" id="increase-<?= $row['id'] ?>" class="bg-gray-100 border px-2 py-1 m-1 increase">
                            <!-- Increase icon SVG here -->
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="flex justify-center items-center">
            <!-- Your input fields and total price display here -->
        </div>

        <div class="flex justify-center items-center">
            <div class="flex justify-center items-center">
                <button type="submit" name="remove" class="remove-item" data-item-id="<?= $row['perfume_id'] ?>">Remove</button>
            </div>
        </div>
    </div>
</form>
