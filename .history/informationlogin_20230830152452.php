                    ...
                    <div class="w-full min-h-[500px] flex justify-center items-center flex-col">
                        ...
                        <form action="" method="post" class="w-[80%]">
                            ...
                            <div class="w-full">
                                ...
                                <div
                                    class="w-full h-96 flex justify-center items-center flex-col bg-white px-10 py-5 mt-14">

                                    <h1 class="text-lg self-start mb-5 mt-10">Log In</h1>
                                    ...
                                    <hr class="border-b border-dashed border-gray-400 mb-10">
                                        ...
                                        <div class="w-full border-b inputval mb-2">
                                            ...
                                            <input type="password" name="loginpassword"
                                                class="w-full focus:outline-none p-4 mt-3 val" placeholder="Password">
                                        </div>
