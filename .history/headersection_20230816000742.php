                    ...
                    <a href="shopcartpage.php" class=" flex justify-center items-center p-2">
                        ...
                        <sup id="bag-count" class="bg-gray-500  font-semibold px-2 py-2 rounded-full">
                            <span class="text-gray-100">
                                ...
                                // Assuming you have a cart table with a 'quantity' column where you store item quantities
                                $query = "SELECT SUM(quantity) AS cartCount FROM addtocart";
                                ...
                                if ($result) {
                                    ...
                                    echo json_encode(array( $cartCount));
                                } else {
