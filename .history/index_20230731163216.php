                ...
                <div class="w-80">
                    ...
                    <div class="h-auto mb-5">
                        ...
                        <form action="index.php" method="get">
                            ...
                            <?php
                            $startprice = isset($_GET['startprice']) ? $_GET['startprice'] : '';
                            $endprice = isset($_GET['endprice']) ? $_GET['endprice'] : '';
                            $updateURL = "index.php?startprice=$startprice&endprice=$endprice&price=1";
                            ?>

                            <!-- <a href="index.php?startprice=$startprice&endprice=$endprice&price=1" type="text"
                                id="updateprice" name="price" class="w-24 border border-2 rounded m-1 p-1">UPDATE</a> -->
                                <a href="<?php echo $updateURL; ?>" type="text" id="updateprice" name="price" class="w-24 border border-2 rounded m-1 p-1">UPDATE</a>
