    ...
    <section class="">
        <div class="grid grid-cols-3">
            ...
            <div class="col-span-2 ">
                ...
                <div class="grid grid-cols-3">
                    <div class="w-full m-5 flex justify-center items-center flex-col">
                        ...
                        <a href="" class="w-64 self-start">
                            Brit by Burbettry EDT 3.3 OZ 100ml spray for Men
                        </a>
                ...
                <div class="grid grid-cols-3">
                    <div class="w-full m-5 flex justify-center items-center flex-col">
                        <img src="./assets/img/perfume/men/men2.jpg" alt="" style="max-width: 200px;">
                        <a href="" class="w-64 self-start">
                            Royal Copenhagen by EDC 8.0 OZ 240ml spray for Men
                        </a>
                        <span class="self-start mt-2">$43.80</span>
                    </div>

                    <div class="w-full m-5 flex justify-center items-center flex-col">
                        <img src="./assets/img/perfume/women/women2.jpg" alt="" style="max-width: 200px;">
                        <a href="" class="w-64 self-start">
                            Jovan White Musk by Coldana EAU 3.25 OZ 96ml spray for Women
                        </a>
                        <span class="self-start mt-2">$30.07</span>
                    </div>

                    <div class="w-full m-5 flex justify-center items-center flex-col">
                        <img src="./assets/img/perfume/unisex/unisex2.jpg" alt="" style="max-width: 200px;">
                        <a href="" class="w-64 self-start">
                            CK be by Calvin Klein EDT 6.7 OZ 200ml spray for Unisex
                        </a>
                        <span class="self-start mt-2">$34.80</span>
                    </div>
                </div>

                <div class="grid grid-cols-3">
                    <div class="w-full m-5 flex justify-center items-center flex-col">
                        <img src="./assets/img/perfume/men/men3.jpg" alt="" style="max-width: 200px;">
                        <a href="" class="w-64 self-start">
                            Eternity by Burbettry EDT 3.3 OZ 100ml spray for Men
                        </a>
                        <span class="self-start mt-2">$33.80</span>
                    </div>

                    <div class="w-full m-5 flex justify-center items-center flex-col">
                        <img src="./assets/img/perfume/women/women3.jpg" alt="" style="max-width: 200px;">
                        <a href="" class="w-64 self-start">
                            Charlie Blue by Revlon EAU 3.3 OZ 100ml spray for Women
                        </a>
                        <span class="self-start mt-2">$34.78</span>
                    </div>

                    <div class="w-full m-5 flex justify-center items-center flex-col">
                        <img src="./assets/img/perfume/unisex/unisex3.jpg" alt="" style="max-width: 200px;">
                        <a href="" class="w-64 self-start">
                            CK all one by Calvin Klein EDT 6.7 OZ 200ml spray for Unisex
                        </a>
                        <span class="self-start mt-2">$38.80</span>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-3">
                    <div class="w-full m-5 flex justify-center items-center flex-col">
                        <img src="./assets/img/perfume/women/women4.jpg" alt="" style="max-width: 200px;">
                        <a href="" class="w-64 self-start">
                            CK be by Calvin Klein EDT 6.7 OZ 200ml spray for Women
                        </a>
                        <span class="self-start mt-2">$90.88</span>
                    </div>

                    <div class="w-full m-5 flex justify-center items-center flex-col">
                        <img src="./assets/img/perfume/men/men4.jpg" alt="" style="max-width: 200px;">
                        <a href="" class="w-64 self-start">
                            Halston z-14 by Cologen EAU 8.0 OZ 238ml spray for Men
                        </a>
                        <span class="self-start mt-2">$35.78</span>
                    </div>

                    <div class="w-full m-5 flex justify-center items-center flex-col">
                        <img src="./assets/img/perfume/unisex/unisex4.jpg" alt="" style="max-width: 200px;">
                        <a href="" class="w-64 self-start">
                            CK one by Calvin Klein EDT 3.3 OZ 100ml spray for Unisex
                        </a>
                        <span class="self-start mt-2">$44.80</span>
                    </div>
                </div>
