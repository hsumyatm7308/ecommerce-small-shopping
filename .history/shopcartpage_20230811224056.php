...
<body>
    ...
    In this code, I've added an ID to each total price element that is unique to the item. When the "Remove" button is
    clicked, the associated total price element is located using the ID and its value is retrieved. This value can then
    be used or processed as needed in your JavaScript code.
