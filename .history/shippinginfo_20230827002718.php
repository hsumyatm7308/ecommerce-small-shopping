            ...
            <div class="col-span-3 w-full flex justify-start items-center flex-col">
                ...
                <section class="w-full flex justify-center items-center">
                    <div class="w-full min-h-[500px] flex justify-center items-center flex-col">
                        ...
                        <form action="" method="post" class="w-[80%] flex justify-center items-center flex-col">
                            ...
                            <div class="w-full">
                                ...
                                <div class="w-full border-gray-400 border-2 p-5 flex justify-center items-center flex-col  guestinfo">
                                    ...
                                    <div class="w-full border-b-2 border-gray-400 inputval mb-8">
