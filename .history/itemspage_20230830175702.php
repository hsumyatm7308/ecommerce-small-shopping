    ...
    <div class="grid grid-cols-2">
      <div class="flex justify-center items-center">
        <div class="w-[500px] h-[590px] border flex justify-center items-center">
          ...
          $id = $_GET['items'];
          $imgstmt = $conn->prepare("SELECT imgurl FROM perfume WHERE id = :id ");
          ...
          echo '<img src="data:image/jpeg;base64,' . $base64_image . '" alt="" width="500px">';
          ...
          if (isset($_GET['items'])) {
            ...
            if ($itemId === $row['id']) {
              ...
              <div class="flex items-center mt-3">
                  <span id="decrease" class="bg-gray-100 border px-2 py-1 m-1 shadow hover:bg-gray-200">
                  ...
                  <span id="increase" class="bg-gray-100 border px-2 py-1 m-1 shadow hover:bg-gray-200">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
  ...
  <script class="text/javascript">
    $(document).ready(function () {
      ...
      $("#addtocart").click(function () {
        ...
        var perfumeimg = "<?php echo $_GET['items'] ?>";
        console.log(perfumeimg);

        console.log(perfumename, mili, brandname, categoryname, pfimg);
        ...
        $alert = $conn->prepare("SELECT id FROM addtocart WHERE perfume_id = :id AND temporaryid = :temp");
        $alert->bindParam(':id', $_GET['items']);
        $alert->bindParam(':temp', $row['id']);
        $alert->execute();

        if ($alert->rowCount() > 0) {
          echo '
        $("#alertcart").html(`<div class="w-96  bg-green-100 flex justify-between items-center mt-3 p-2 border border-red-100">
            <span class="flex justify-start items-center p-1">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 ml-4 text-red-500">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" />
                </svg>
       ...
       ';
          ...
          echo '
          $("#alertcart").html(`<div class="w-96  bg-green-100 flex justify-between items-center mt-3 p-2 ">
              <span class="flex justify-start items-center p-1">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 ml-4 text-green-400">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" />
                  </svg>
