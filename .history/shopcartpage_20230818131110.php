            ...
            <div
                ...
                <div class="w-[500px] h-[300px] bg-stone-100 flex justify-center items-center flex-col  rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     ...
                     <div class='mt-6'>
                        <button class="bg-gray-400 border rounded-md px-5 py-1 m-1 hover:opacity-80 hover:text-white focus:shadow-lg">Okay</button>
                        <button class="border-2 border-indigo-100 rounded-md px-5 py-1 m-1 hover:border-indigo-200">Cancle</button>
                     </div>
                </div>
