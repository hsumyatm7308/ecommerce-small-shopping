                                ...
                                <div class="flex justify-center items-center">
                                    <div class="flex justify-center items-center">
                                        <button type="submit" name="" id=""
                                            class="px-3 py-1 bg-gray-400 rounded-md shadow removeitem hover:text-white"
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class='flex justify-center items-center mt-6'>
                                                ...
                                                <form action="shopcartpage.php?remove" method="post">
                                                    <div class="flex justify-center items-center">
                                                        <div class="flex justify-center items-center">
                                                            <button type="submit" name="remove"
                                                                id="remove-<?= $row['perfume_id'] ?>"
                                                                class="px-3 py-1 bg-gray-400 rounded-md shadow remove-item-comfirm hover:text-white"
                                                                data-item-id="<?= $row['perfume_id'] ?>">Okay</button>
                                                        </div>
                                                    </div>
                                                </form>
        ...
        $(document).ready(function () {
            ...
            $('.removeitem').each(function () {
                $(this).click(function () {
                    ...
                    // Bind the AJAX request to the "Okay" button click
                    $('.modal-container .remove-item-confirm').click(function () {
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                // Adjust any further actions if needed
                                // For example, you might want to refresh the page or update the cart display
                            }
                        });

                        // Close the modal after clicking "Okay"
