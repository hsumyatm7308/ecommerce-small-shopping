...
<body>
                    ...
                    <div class="w-[90%] mt-10">
                        ...
                        if (!empty($_SESSION['cart'])) {
                            ...
                            <div class="flex justify-center items-center">
                              ...
                              <a href="shopcartpage.php?action=remove&id=' . $value['id'] . '" onclick="deleteitem(' . $value['id'] . ')>
                                  <button class="px-3 py-1 bg-gray-100 remove-btn" name="deletebtn" ">Remove</button>
                               </a>
                             </div>
    ...
    <script>
        ...
        var currentItem = $(this).closest(".cart-item");

        // $(document).ready(function () {
        function deleteitem(id) {
            $.ajax({
                url: "./addtocart/deleteitem.php",
                type: "POST",
                data: {
                    id: id,
                    action: "delete"
                ...
                success: function (response) {
                    if (response == 1) {
                        ...
                        // Remove the item's div from the UI
