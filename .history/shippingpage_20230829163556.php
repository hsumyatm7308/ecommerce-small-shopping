...
<body class="bg-gray-100">
    ...
    <section class="">
        ...
        <div class="grid grid-cols-6">
            ...
            <div class="col-span-4 w-full bg-[#ffff] flex justify-start items-center flex-col">
                <!-- head  -->
                        ...
                        <form action="" method="post" class="w-[80%]">
                            <div class="w-full">
                                ...
                                <div class="mt-10">
                                    ...
                                    <div class="w-full h-[300px] flex justify-center items-center flex-col border border-2 border-gray-400 p-5 shipmethodctn">
