                ...
                <div class="col-span-2 flex justify-center items-start">
                    ...
                    <div class="w-[90%] mt-10">
                        ...
                        if (!empty($_SESSION['cart'])) {
                            ...
                            <div class="flex justify-center items-center">
                                 <a href="shopcartpage.php?action=remove&id=' . $value['id'] . '" class="px-3 py-1 bg-gray-100 remove-item" data-item-id="' . $value['id'] . '">Remove</a>
                            </div>
                             </div>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        removeButtons.forEach(button => {
            button.addEventListener('click', (event) => {
                // You might want to add a confirmation dialog before removing the item
