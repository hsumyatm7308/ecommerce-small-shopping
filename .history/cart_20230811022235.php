...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (isset($_POST["quantity"])) {
        ...
        try {
            ...
            $cartstmt->bindParam(':perfumname', $row['perfume_name']);
            $cartstmt->bindParam(':perfumeprice', $row['brand_name']);
            ...
            while ($row = $cartstmt->fetch()) {
                ...
                echo $row['perfume_name'];

                $perfumeName = "Sample Perfume"; // Replace with your perfume name
                $brandName = "Sample Brand"; // Replace with your brand name
