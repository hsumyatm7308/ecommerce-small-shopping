...
<body>
                    ...
                    <div class="w-[90%] mt-10">
                        ...
                        if (!empty($_SESSION['cart'])) {
                            ...
                            <div class="flex justify-center items-center">
                                ...
                                <input   type="text" id="totalprice" class="w-20 p-1 totalprice"  value="$' . number_format($value['quantity'] * $value['price'], 2) . '" readonly >
                            </div>
                            ...
                            <div class="flex justify-center items-center">
                                <a href="shopcartpage.php?action=remove&id=' . $value['id'] . '" >
                                   <button class="remove-item" data-item-id="' . $value['id'] . '">Remove</button>
                               </a>
                            </div>
                             </div>
    ...
    <script>
        ...
        const quantityInput = document.querySelector('.valueInput');
        const totalpriceInput = document.getElementById('totalprice');

        // Initial total price calculation
        const initialTotalPrice = parseFloat(quantityInput.value) * parseFloat($value['price']);
        ...
        function updateTotalPrice() {
            ...
            const newTotalPrice = newQuantity * parseFloat($value['price']);
