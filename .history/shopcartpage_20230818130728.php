            ...
            <div
                ...
                <div class="w-[500px] h-[300px] bg-stone-100 flex justify-center items-center flex-col  rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     ...
                     <span class="mt-1">Are you sure want to delete this item?</span>

                     <div class='mt-6'>
                        <button class="bg-gray-400 px-5 py-1 m-1">Okay</button>
                        <button class="border px-5 py-1 m-1">Cancle</button>
                     </div>
                </div>
