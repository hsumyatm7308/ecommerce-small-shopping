                        ...
                        <form action="shopcartpage.php" method="post">
                            ...
                            <div class="item flex justify-center items-center p-1">
                                <div class="flex items-center">
                                    <!-- Decrease button -->
                                    <span id="decrease-' . $value['id'] . '" class="bg-gray-100 border px-2 py-1 m-1 decrease-' . $value['id'] . '">
                                    ...
                                    <!-- Increase button -->
                                    <span id="increase-' . $value['id'] . '" name="increase" class="bg-gray-100 border px-2 py-1 m-1 increase-' . $value['id'] . '">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
...
<script>
    // JavaScript to handle quantity changes and total price updates
    document.addEventListener("DOMContentLoaded", function () {
        const decreaseButton = document.getElementById("decrease-<?= $value['id'] ?>");
        const increaseButton = document.getElementById("increase-<?= $value['id'] ?>");
        const quantityInput = document.getElementById("quantity-<?= $value['id'] ?>");
        const price = <?= $value['price'] ?>;
        const totalpriceInput = document.getElementById("totalprice-<?= $value['id'] ?>");
