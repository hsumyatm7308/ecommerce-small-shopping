                    ...
                    if (isset($_GET['items'])) {
                      ...
                      try {
                        ...
                        while ($row = $stmt->fetch()) {
                          $totalStars += $row['userrating'];
                        }

                        // Calculate the average star rating
                        // $averageStarRating = ($totalRowCount > 0) ? $totalStars / ($totalRowCount * 5) : 0;

                        // Convert average star rating to percentage
                        $averageStarRatingPercentage = ($averageStarRating > 0) ? $averageStarRating * 100 : 0;

                        echo "Average Star Rating: " . $averageStarRating . " (" . $averageStarRatingPercentage . "%)";
