    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (clickedLetters) {
            ...
            for (const letter of clickedLetters) {
                ...
                const targetURL = "http://localhost/perumcommance/ecommerce/menfrg.php?menpage=1&letters=H&letters=D&letters=D&letters=E&letters=H&letters=J&letters=S&letters=R&letters=C&letters=G";
