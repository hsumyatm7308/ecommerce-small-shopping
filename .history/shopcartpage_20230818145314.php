                    ...
                    <div class="w-[90%] mt-10 itemscontainer">
                        ...
                        <?php while ($row = $stmt->fetch()): ?>
                            ...
                            <div id="<?= $row['perfume_id'] ?>"
                                ...
                                <button
                                    class="border-2 border-indigo-100 rounded-md px-5 py-1 m-1 hover:border-indigo-200 focus:ring-1 delete<?php  $row['perfume_id']  ?>">Delete</button>
                            ...
                            <script>
                             const delete<?php  $row['perfume_id']  ?> =document.querySelector('.delete<?php  $row['perfume_id']  ?>');
                             console.log(delete<?php  $row['perfume_id']  ?>);
                            </script>
