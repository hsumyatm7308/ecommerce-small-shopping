...
<body>
                    ...
                    <div class="w-[90%] mt-10">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="flex justify-center items-center">
                                ...
                                <input  type="text" id="" class="w-20 p-1 totalprice"  value="$' . number_format($value['quantity'] * $value['price'], 2) . '" readonly >
                            </div>

                            <div class="flex justify-center items-center">
                                <div class="flex justify-center items-center">
                                    <button name="remove" class="remove-item" data-item-id="' . $value['id'] . '">Remove</button>
                                 </div>
                             </div>
                        
                             <input type="hidden" name="id" value="' . $value['id'] . '">
                             <input type="hidden" name="price" value="' . $value['id'] . '">
                             <input type="hidden" name="quantity" value="' . $value['id'] . '">
    ...
    if (isset($_POST['remove']) && isset($_POST['id'])) {
        ...
        // Search for the item to remove based on its ID and unset it from the cart
        foreach ($_SESSION['cart'] as $key => $value) {
            if ($value['id'] === $removeItemId) {
                unset($_SESSION['cart'][$key]);
                break; // No need to continue searching after the item is found and removed
            }
        }
    }
