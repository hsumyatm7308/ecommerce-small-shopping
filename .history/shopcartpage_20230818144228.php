                        ...
                        <?php while ($row = $stmt->fetch()): ?>
                                            ...
                                            <div
                                                ...
                                                <div class='flex justify-center items-center mt-6'>
                                                    <form action="shopcartpage.php?remove=<?= $row['perfume_id'] ?>"
                                                        ...
                                                        <div class="flex justify-center items-center">
                                                            <div class="flex justify-center items-center">
                                                                <button type="submit" name="remove" id="removebtn<?= $row['perfume_id'] ?>"
                            ...
                            <script>
                                $(document).ready(function () {
                                    ...
                                    var remove<?= $row['perfume_id'] ?> = document.getElementById('remove-<?= $row['perfume_id'] ?>');


                                    console.log(remove<?= $row['perfume_id'] ?>)
