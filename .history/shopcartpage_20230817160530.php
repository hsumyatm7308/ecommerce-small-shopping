                            ...
                            <?php while ($row = $stmt->fetch()): ?>
                                ...
                                <script>
                                    ...
                                    for (var i = 0; i < totalpriceInputs.length; i++) {
                                        var totalpriceInput = totalpriceInputs[i]; // Get the current total price input element
                                        var totalPriceValue = parseFloat(totalpriceInput.value.replac e('$', '')); // Extract the numeric value
