            ...
            <div class="col-span-3 w-full flex justify-start items-center flex-col">
                ...
                <section class="w-full flex justify-center ">
                    ...
                    <div class="w-full flex justify-between items-center mt-5">
                        ...
                        <div class="">
                            <form action="" method="post">
                                <button type="submit" name="ctntoship" class="bg-gray-300 uppercase p-2 ctntoshipbtn">
                                    <h1 class="text-sm p-1 rounded">Continue to shipping</h1>
                                </button>
                            </form>
                        </div>
                    ...
                    <form action="" method="post" class="w-[80%] registerinfo">
                        ...
                        <div class="w-full">
                            ...
                            <div class="w-full border border-2 p-5 ">
                                ...
                                <div class="w-full border-b inputval mb-2">
                                    <input type="password" name="regpassword" class="w-full focus:outline-none p-4 val"
                                        placeholder="Password">
                                </div>

                                <div class="w-full flex justify-end items-center">
                                    <button class=" focus:outline-none p-4">
                                        <span id="loginfromreg" class="text-indigo-500"> Login</span>
