                                ...
                                <div class="w-full border border-2 p-5 ">
                                    <div class="grid grid-cols-4 border-b border-b-solid border-b-gray-300 px-3 py-2">
                                        ...
                                        <div class="col-span-2">
                                            ...
                                            <input type="hidden" class="inputtype" value="<?php echo $row['email'] ?>">
                                        </div>
                                    ...
                                    <div class="grid grid-cols-4  p-3">
                                        ...
                                        <div class="col-span-2">
                                            ...
                                            <input type="hidden" class="inputtype"
                                                value="<?php echo $rowaddr['address'] ?>">
    ...
    <script>
        ...
        for (let i = 0; i < changebtn.length; i++) {
            changebtn[i].addEventListener('click', function () {
                ...
                inputtype[i].innerHTML = "text";
                inputtype[i].autofocus = true;

                inputtype[i].setAttribute('autofocus', 'autofocus');
