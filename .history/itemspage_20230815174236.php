            ...
            if ($itemId === $row['id']) {
              ...
              <input type="hidden" name="id" value="{$row['id']}">
               ...
               <div class="  flex  items-center mt-3">
                   ...
                   <button type="button" name="addtocart" class="w-32 text-gray-100 bg-gray-500 flex justify-center items-center drop-shadow-lg p-1 hover:drop-shadow-[0_5px_5px_#09090b]" id="addtocart" >Add to cart</button>
              </div>
