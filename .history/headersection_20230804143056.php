<style>
    ...
    /* Add background image to the navbgmarker class */
    .navbgmarker {
        position: relative;
    ...
    /* Position the text on top of the background image using absolute positioning */
    .navbgmarker a {
        position: absolute;
        top: 50%;
        left: 50%;
        ...
        <nav class="w-screen h-auto  flex items-center grid grid-cols-4 p-3">
            ...
            <div class="flex justify-start items-center">
                <ul class="flex justify-start items-center text-[15px] uppercase ">
                    <li class="mr-5 navbgmarker"><a href="index.php?page=1">All</a></li>
