                    ...
                    <div class="w-[400px] min-h-[300px] bg-gray-100 mt-10 flex  items-center flex-col px-5 py-7">
                        ...
                        <div class="w-[85%] flex items-center flex-col mt-3">
                            ...
                            <script>
                                ...
                                var qtyinputList = document.querySelectorAll('.valueinput'); // Select all elements with the class .valueinput

                                var subtotalist = 0;

                                for (var i = 0; i < qtyinputList.length; i++) {
                                    var qtyinput = qtyinputList[i]; // Get the current input element
                                    console.log(qtyinput);
                                    // You can perform further operations with qtyinput, such as calculating the subtotal
                                }
