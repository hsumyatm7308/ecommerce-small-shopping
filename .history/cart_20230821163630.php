...
// Check if a temporary customer ID exists in the user's session.
if (!isset($_SESSION['temp_customer_id'])) {
    // If not, generate a unique temporary customer ID.
    $temp_customer_id = uniqid('temp_customer_'); // You can use any unique identifier generation method you prefer.

    // Store the temporary customer ID in the user's session.
