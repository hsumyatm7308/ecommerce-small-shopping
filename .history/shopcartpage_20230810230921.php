...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    // Check if the 'qty' parameter is set in the POST request
    if (isset($_POST["qty"])) {
        $qty = $_POST["qty"];

        // Process the qty value as needed
        // For example, you can store it in a database, perform calculations, etc.

        // Send a response back to the client
        echo "Qty received and processed: " . htmlspecialchars($qty);
    } else {
        echo "Qty parameter is missing in the request.";
    }
} else {
    echo "Invalid request method huh.";
}
?>
                ...
                <div class="col-span-2 flex justify-center items-start">
                    ...
                    <div class="w-[90%] mt-10">
                        ...
                        <div class=" grid grid-cols-6 justify-center items-center border-b mb-4">
                            <div class="col-span-2 flex justify-center items-center">
                                <img src="./assets/img/perfume/men/men1.jpg" alt="" class="" width="100px">
                                 <span class="ml-10">Davidoff Cool Water by Aidonull EDT 3.3 OZ 200ML spray for Men</span>
                            </div>
                ...
                <div class="w-full flex justify-start items-center flex-col">
                    <div class="w-[400px] min-h-[300px] bg-gray-100 mt-10 flex  items-center flex-col px-5 py-7">
                        ...
                        <div class="w-[85%] flex items-center flex-col mt-3">
                                ...
                                <li class="w-full flex justify-between  mb-2"><span>Davidoff Cool Water</span>  <span>$50</span></li>
                                <li class="w-full flex justify-between  mb-2"><span>Navy</span>  <span>$30</span></li>
                                <li class="w-full flex justify-between  mb-2"><span>Davidoff Cool Water</span>  <span>$50</span></li>
                                <li class="w-full flex justify-between  mb-2"><span>Navy</span>  <span>$30</span></li>
                                <li class="w-full flex justify-between  mb-2"><span>Davidoff Cool Water</span>  <span>$50</span></li>
