        ...
        <div class="w-full p-8">
            <div class="grid grid-cols-3">
                <div class="col-span-2 flex justify-center items-start">
                    ...
                    <div  id="cartItemsContainer" class="w-[90%] mt-10">
                        ...
                        <div id="" class="cart-item grid grid-cols-6 justify-center items-center border-b mb-4">
                            <div class="col-span-2 flex justify-center items-center">
                                ...
                                <span class="ml-10">' . $perfumename . 'by EDT 3.3 OZ
                                ...
                                <div class="flex justify-center items-center p-1">
                                    <div class="item flex justify-center items-center p-1">
                                        <div class="flex items-center">
                                            ...
                                            <span id="increase-' . $id . '" name="increase"
                            ...
                            <div class="flex justify-center items-center">
                                ...
                                <input type="text" id="totalprice-' . $id . '"
