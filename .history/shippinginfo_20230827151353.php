                                    ...
                                    <div class="w-full grid grid-cols-2 mb-8">
                                        ...
                                        <div class="w border-b-2 border-gray-300 inputval mb-2 mr-5">
                                                <input type="text" name="firstname"
                                                    class="w-full focus:outline-none focus:bg-transparent p-2 val" placeholder="First Name">
                                        </div>
                ...
                try {
                    ...
                    if ($temp_customer_id) {
                        ...
                        if ($rowCount > 0) {
                            ...
                            $updateStmt = $conn->prepare('UPDATE shippingaddress SET firstname,lastname,phone,address,city,company, temporaryid WHERE temporaryid = :tempid');
