    ...
    function handleLetterClick(letter) {
        ...
        for (const letter of updatedLetters) {
            ...
            innerSpan.addEventListener('click', function () {
                ...
                // Remove the clicked letter from the clickedLetters string
                clickedLetters = clickedLetters.replace(clickedLetter, '');

                // Save the updated clickedLetters back to sessionStorage
