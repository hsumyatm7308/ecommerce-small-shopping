        ...
        <div class="w-full p-8">
            <div class="grid grid-cols-3">
                ...
                <div class="w-full flex justify-start items-center flex-col">
                    <div class="w-[400px] min-h-[300px] bg-gray-100 mt-10 flex shadow shadow-lg border items-center flex-col px-5 py-7">
                            ...
                            <?php while ($row = $stmt->fetch()): ?>
                                ...
                                <li class="w-full flex justify-between mb-2">
                                    ...
                                    <input type="text" id="totallist-<?php echo $row['perfume_id']; ?>"
                                        class="w-20 p-1 bg-transparent focus:outline-none " value="$ <?php echo $total; ?>" readonly>
                                </li>
                    ...
                    <div class="w-[400px] h-16 bg-gray-200 flex justify-center items-center mt-10 drop-shadow  border hover:border-2">
