                        ...
                        <form action="" method="post" class="w-[80%]">
                            ...
                            <div class="w-full">
                                ...
                                <div class="w-full border border-2 p-5">
                                    ...
                                    <div class="w-full border-b border 	 ">
                                        <input type="text" name="customername" class="w-full focus:outline-none p-4 inputval"
                                            placeholder="Name">
                                    </div>
                                    <div class="w-full border-b">
                                        <input type="text" name="customeremail" class="w-full focus:outline-none p-4 inputval"
                                            placeholder="Email">
                                    </div>

                                    <div class="w-full border-b">
                                        <input type="text" name="customeraddress" class="w-full focus:outline-none p-4 inputval"
                                            placeholder="Address">
                                    </div>
