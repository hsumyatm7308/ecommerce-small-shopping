                        ...
                        <section>
                            <div class="modal-container">
                                ...
                                <form action="shopcartpage.php?remove=<?= $row['perfume_id'] ?>" method="post">
                                    <div class="flex justify-center items-center">
                                        <div class="flex justify-center items-center">
                                            <button type="submit" name="remove" id="remove-<?= $row['perfume_id'] ?>" class="px-3 py-1 bg-gray-400 rounded-md shadow remove-item hover:text-white" data-item-id="<?= $row['perfume_id'] ?>">Remove</button>
                                        </div>
                                    </div>
                                </form>
