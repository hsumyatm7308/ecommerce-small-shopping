        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    updateItemCountUI(data); // Call a function to update the UI with the data

                }
            });
            function updateItemCountUI(count) {
                var countSpan = document.querySelector('.text-gray-100'); // Select the span element
                countSpan.textContent = count; // Update the text content with the received count
            }
        });
