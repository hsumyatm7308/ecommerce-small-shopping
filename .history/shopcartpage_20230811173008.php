                ...
                <div class="col-span-2 flex justify-center items-start">
                    ...
                    <div class="w-[90%] mt-10">
                        ...
                        if (!empty($_SESSION['cart'])) {
                            ...
                            <div class="flex justify-center items-center">
                            <a href="shopcartpage.php?action=remove&id=<?php echo $value['id']; ?>" class="remove-link">
                                <button class="px-3 py-1 bg-gray-100 remove-btn" data-id="<?php echo $value['id']; ?>">Remove</button>
                            </a>
                        </div>
