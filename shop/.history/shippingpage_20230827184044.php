                                        ...
                                        <form action="" method="post">
                                            ...
                                            <div
                                                ...
                                                <div class="col-span-3">
                                                    ...
                                                    <input type="radio" name="shipcost" value="free" id="shipcost"
                                                        class="mycheckbox">
                                            ...
                                            <div
                                                ...
                                                <div class="col-span-3">
                                                    ...
                                                    <input type="radio" name="shipcost" value="fast" id="shipcost">
                                                    <label for="" class="">
                                            ...
                                            <div class="grid grid-cols-4  px-3 py-2">
                                                <div class="col-span-3">
                                                    ...
                                                    <input type="radio" name="shipcost" value="fastest" id="shipcost">
                                                    <label for="" class="">
