...
<body class="w-srceen overflow-x-hidden">
  ...
  <script class="text/javascript">
    $(document).ready(function () {
      ...
      $("#addtocart").click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                console.log('Data sent successfully:', data);
                // Redirect to the same page with the parameter added
                window.location.href = window.location.href + "?itemAdded=true";
            },
        });
    });

    // Check if the URL contains the itemAdded parameter
    ...
    if (urlParams.get('itemAdded') === 'true') {
        ...
        // Remove the parameter after a brief delay
        setTimeout(function () {
            history.replaceState({}, document.title, window.location.pathname);
        }, 5000); // Remove parameter after 5 seconds
    }
