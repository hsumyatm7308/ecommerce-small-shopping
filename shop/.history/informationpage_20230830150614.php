                ...
                <section class="w-full flex justify-center ">
                    <div class="w-full min-h-[500px] flex justify-center items-center flex-col">
                        ...
                        <form action="" method="post" class="w-[80%] ">
                            ...
                            <div class="w-full h-96 flex justify-center items-center flex-col bg-white px-10 py-5 mt-14">
                            <h1 class="text-lg self-start mb-5 -mt-14">As a Guest</h1>


                                <div class="w-full h-auto guestinfo">
                                  
                                <hr class="border-b border-dashed border-gray-400 mb-16">


                                    <div class="w-full border-b inputval mb-2 mt-7">
                                        <label for="">Email</label>
                                        <input type="text" name="customeremail"
                                            class="w-full border-2 border-gray-400 focus:outline-none p-4 mt-3 val" placeholder="Your email">
                                    </div>
                                    ...
                                    <div class="w-full">
                                        ...
                                        <button class="w-full focus:outline-none p-4 mt-8">Use your account
