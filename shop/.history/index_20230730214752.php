                ...
                <div class="w-80">
                    ...
                    <div class="h-auto mb-5">
                        ...
                        <form action="" method="get">
                            ...
                            <button type="text" name="updateprice" class="w-24 border border-2 rounded m-1 p-1">UPDATE</button>
...
<script>
    ...
    document.getElementById("updateprice").addEventListener("click", handleCheckboxClickmen);
