                                        ...
                                        <div class="w-full grid grid-cols-2 mb-8">
                                            ...
                                            <div class="w border-b-2 inputval mb-2 mr-5">
                                                <input type="text" name="firstname"
                                                    class="w-full border border-gray-400 rounded bg-transparent focus:outline-none focus:bg-transparent p-2 val"
                                                    placeholder="First Name">
                                            </div>

                                            <div class="w border-b-2  inputval mb-2 ml-5">
                                                <input type="text" name="lastname"
                                                    class="w-full border-2 border-gray-400 rounded bg-transparent focus:outline-none p-2 val"
