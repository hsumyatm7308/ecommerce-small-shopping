...
<body class="w-srceen overflow-x-hidden">
        ...
        <div class="mr-10">
          ...
          <div class="mt-5">
            <div class="flex items-center">
              ...
              <span id="writereview" class="m-3 cursor-pointer" onclick="writereviewfun()">Write review <span>(<span
                    id="totalreview">0</span>
                  Reviews)</span></span>
            </div>
            <div class="mb-3">
              <div>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function () {
      var rating_data = 0; // Initialize rating_data to 0

      $(document).on('click', '.submit-star', function () {
        rating_data = $(this).data('rating'); // Update rating_data to the clicked star rating
      ...
      $("#submitreview").click(function () {
        ...
        // No need to get rating_data from the stars here

        console.log(rating_data); // Now, this will show the correct rating_data
