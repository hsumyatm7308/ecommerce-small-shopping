    ...
    $(document).ready(function () {
      ...
      $("#addtocart").click(function () {
        ...
        $.ajax({
          ...
          success: function (data) {
            console.log('Data sent successfully:', data); // Check the response here
            var dataArray = data.split(","); // Split the response into an array
            var receivedPerfumeName = dataArray[0]; // Extract perfume name
            var receivedId = dataArray[1]; // Extract id
            console.log('Received Perfume Name:', receivedPerfumeName);
