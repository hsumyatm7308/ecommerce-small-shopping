                        ...
                        <form action="index.php" method="get">
                            ...
                            <script>
                                function updatePrice() {
                                    ...
                                    var updateURL = "index.php?page&startprice=" + startprice + "&endprice=" + endprice + "&price=1";
...
<script>
    ...
    function handleCheckboxClick() {
        ...
        if (checkbox.checked) {
            window.location.href = "index.php?page&type=on&unisexquery=1";
        } else {
    ...
    function handleCheckboxClickmen() {
        ...
        if (mcheckbox.checked) {
            window.location.href = "index.php?page&type=mon&menquery=1";
        } else {
            window.location.href = "index.php";
        }
    }
    ...
    function handleCheckboxClickwomen() {
        ...
        if (fcheckbox.checked) {
            window.location.href = "index.php?page&type=fon&womenquery=1";
        } else {
            window.location.href = "index.php";
        }
    }
