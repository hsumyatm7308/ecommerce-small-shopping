...
if (isset($_GET['letters']) && is_array($_GET['letters'])) {
    ...
    foreach ($letters as $letter) {
        ...
        try {
            ...
            $menstmt = $conn->prepare("SELECT id, perfume_name, brand_name, category_name, price, imgurl, mili FROM perfume  WHERE category_name IN ('Men','Unisex') AND letter = :letter ORDER BY letter ASC");
