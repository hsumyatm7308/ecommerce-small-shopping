...
<div class="flex justify-center items-center mt-10 p-10">
    ...
    if (isset($_GET['type']) && $_GET['type'] === 'on') {
    ...
    }elseif (isset($_GET['startprice']) && $_GET['endprice']) {
        $startprice = $GET['startprice'];
        $endprice = $GET['endprice'];
        ...
        if (isset($_GET['pricequery'])) {
            ...
            echo '?startprice=$startprice&endprice=$endprice?pricequery=1`" class="text-blue-500 border px-2 py-1 ml-10">Next</a>';
        }
    } else {
