...
try {
    global $conn;
    $query = "SELECT id, perfume_name, brand_name, category_name, price, imgurl, mili FROM perfume WHERE category_name IN ('Men','Unisex','Women')";

    // Check if type filter is set
    if (isset($_GET['type'])) {
        $type = $_GET['type'];
        if ($type === 'on') {
            $query = "SELECT id, perfume_name, brand_name, category_name, price, imgurl, mili FROM perfume WHERE category_name = 'Unisex'";
        } elseif ($type === 'mon') {
            $query = "SELECT id, perfume_name, brand_name, category_name, price, imgurl, mili FROM perfume WHERE category_name = 'Men'";
        } elseif ($type === 'fon') {
            $query = "SELECT id, perfume_name, brand_name, category_name, price, imgurl, mili FROM perfume WHERE category_name = 'Women'";
        }
    }
    ...
    if (isset($_GET['startprice']) && isset($_GET['endprice'])) {
        ...
        $query = "SELECT id, perfume_name, brand_name, category_name, price, imgurl, mili FROM perfume WHERE price BETWEEN :startprice AND :endprice AND category_name IN ('Men','Unisex','Women')";
    }
} catch (Exception $e) {
