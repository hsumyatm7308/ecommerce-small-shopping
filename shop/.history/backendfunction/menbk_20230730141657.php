...
if (isset($_GET['letters'])) {
    ...
    try {
        ...
        $men = $conn->prepare("SELECT id, perfume_name, brand_name, category_name, price, imgurl, mili FROM perfume  WHERE category_name IN ('Men','Unisex') AND fsletter = :letter ORDER BY fsletter ASC");
        $men->bindParam(":letter", $letter);
        $men->execute();
