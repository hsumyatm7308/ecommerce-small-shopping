...
try {
    ...
    if (isset($_GET['search'])) {
        ...
        if (isset($_POST['dec'])) {
            ...
            $stmt = $conn->prepare('
                SELECT P.id, P.perfume_name, P.brand_name, P.category_name, P.price, P.imgurl, P.mili, IFNULL(COUNT(R.perfume_id), 0) as review_count
                FROM perfume as P
            ...
            $stmt = $conn->prepare("
                ...
                FROM perfume
                WHERE category_name IN ('Men', 'Unisex', 'Women')
                ORDER BY $sortOption;
            ");
        }
