        ...
        if (isset($_GET['type']) && $_GET['type'] === 'on') {
            ...
            if (isset($_GET['menquery'])) {
                if ($_GET['menquery'] >= $totalpages) {
                    ...
                    echo '<a href="?menpage=1&menpagetype=mon&menquery=' . $nextPage . '" class="text-red-500 border px-2 py-1 ml-10">Next</a>';
                }
            } else {
                echo '<a href="?menpage=1&menpagetype=mon&menquery=1" class="text-blue-500 border px-2 py-1 ml-10">Next</a>';
            }
