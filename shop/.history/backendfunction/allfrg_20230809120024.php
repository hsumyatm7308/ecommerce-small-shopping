...
try {
    ...
    // Note: You cannot directly assign a prepared statement to $sortOption
    // Instead, set it to a string representing the sorting criteria
...
// Process and display the sorted data
foreach ($sortedData as $row) {
    // Process and display each row as needed
    // For example: echo $row['perfume_name'], $row['review_count'], ...
}
