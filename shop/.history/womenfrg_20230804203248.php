                ...
                <ul class="flex justify-center items-center">
                    ...
                    <form action="" method="post" class="flex justify-center items-center">
                        ...
                        if (isset($_POST['asc'])) {
                            ...
                            echo '<li class="mr-5" name="asc">
                            <button type="submit" name="asc" class="text-blue-200"> Ascending price</button>
                        </li>';
                        } elseif (isset($_POST['dec'])) {
                            echo '  <li class="mr-5">
                           <button type="submit" name="dec" class="text-blue-200"> Descending price</button>
                       </li>';
                        }
