...
if (isset($_POST['action']) && $_POST['action'] === "data") {
    ...
    if ($id) {
        ...
        if ($checkstmt->rowCount() > 0) {
            ...
            $cartstmt = $conn->prepare("INSERT INTO addtocart(perfumeimg, perfumename,brandname,mili,category,perfumeprice,quantity,totalprice,perfume_id,temporaryid) VALUES (:name,:brand,:mili,:ctg,:price,:qty,:ttprice,:id,:tempid)");
