  ...
  <section class="mt-7">
    ...
    <div class="grid grid-cols-2">
      ...
      <div>
          ...
          <div>
            <?php
              if(isset($_GET['items'] ) && isset($_GET['items']) === $row['id'])
            ?>
            <h1 class="text-3xl"><?php $row['perfume_name'] ?>  by <?php $row['brand_name'] ?> EDT 3.3 OZ <?php $row['mili'] ?> spray for <?php $row['category_name'] ?></h1>
