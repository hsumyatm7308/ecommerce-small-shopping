                    ...
                    <div class="w-full min-h-[500px] flex justify-center items-center flex-col">
                        ...
                        <form action="" method="post" class="w-[80%] ">
                            ...
                            <div class="w-full">
                                ...
                                <div class="flex  mb-1 mt-16 ">
                                    <h1 class="text-3xl font-semibold">Shipping Information</h1>
                                ...
                                <div class="bg-[#ffff] mt-10 rounded shadow mb-10 px-10 pt-10 py-20 ">
                                    ...
                                    <div
                                        class="w-full  p-5 mt-10 mb-8 flex justify-center items-center flex-col  guestinfo">
                                        ...
                                        <div class="w-full grid grid-cols-2 mb-8">
                                            ...
                                            <div class="w border-b-2 inputval mb-2 mr-5">
                                                <label for="" class="">First Name</label>
                                                <input type="text" name="firstname"
                                                    class="w-full border-2 border-gray-400 rounded bg-transparent focus:outline-none focus:bg-transparent p-2 mt-2 val"
                                            ...
                                            <div class="w inputval mb-2 ml-5">
                                                ...
                                                <input type="text" name="lastname"
                                                    class="w-full border-2 border-gray-400 rounded bg-transparent focus:outline-none p-2 mt-2 val"
                                        ...
                                        <div class="w-full mb-8">
                                            ...
                                            <input type="text" name="company"
                                                class="w-full border-2 border-gray-400 rounded bg-transparent focus:outline-none mt-2 p-2 "
                                                placeholder="option">
                                        </div>
                                        ...
                                        <div class="w-full inputval mb-8">
                                            ...
                                            <input type="text" name="address"
                                                class="w-full border-2 border-gray-400 rounded  bg-transparent focus:outline-none mt-2 p-2 val"
                                                placeholder="">
                                        </div>
                                        ...
                                        <div class="w-full inputval mb-8">
                                            ...
                                            <input type="text" name="city"
                                                class="w-full border-b-2 border-gray-300 bg-transparent focus:outline-none mt-2 p-2 val"
                                                placeholder="City">
                                        </div>
            ...
            if ($firstname === '' || $lastname === '' || $address === '' || $city === '') {
                ...
                if ($temp_customer_id) {
                    ...
                    if ($rowCount > 0) {
                        ...
                        $updateStmt->bindParam(":tempid", $row['id']);
                        $updateStmt->execute();
