...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $updateemail = $conn->prepare("UPDATE customerinfo SET email = :email WHERE temporary_id = :tempid");
        $updateemail->bindParam('email', $emailvalue);
        $updateemail->bindParam('temp', $rowtemp['id']);
        $updateemail->execute();
        
        $updateaddr = $conn->prepare("UPDATE shippingaddress SET email = :email WHERE temporaryid = :tempid");
