                    ...
                    <div class="w-full min-h-[500px] flex justify-center items-center flex-col">
                        ...
                        <form action="" method="post" class="w-[80%] ">
                            ...
                            <div class="w-full">
                                ...
                                <div
                                    class="w-full border-gray-300 border p-5 mt-10 mb-8 flex justify-center items-center flex-col  guestinfo">
                                    ...
                                    <div class="w-full grid grid-cols-2 mb-8">
                                        ...
                                        <div class="w border-b-2 border-gray-300 inputval mb-2 mr-5">
                                            <input type="text" name="firstname"
                                                class="w-full bg-transparent focus:outline-none focus:bg-transparent p-2 val"
                                                placeholder="First Name">
                                        </div>

                                        <div class="w border-b-2 border-gray-300 inputval mb-2 ml-5">
                                            <input type="text" name="lastname" class="w-full bg-transparent focus:outline-none p-2 val"
                                    ...
                                    <div class="w-full border-b-2 border-gray-300  mb-8">
                                        <input type="text" name="company" class="w-full bg-transparent focus:outline-none p-2 "
                                            placeholder="Company (Option)">
                                    </div>


                                    <div class="w-full border-b-2 border-gray-300  mb-8">
                                        <input type="text" name="phone" class="w-full bg-transparent focus:outline-none p-2 "
                                            placeholder="Phone Number (Option)">
                                    </div>


                                    <div class="w-full border-b-2 border-gray-300 inputval mb-8">
                                        <input type="text" name="address" class="w-full bg-transparent focus:outline-none p-2 val"
                                            placeholder="Address">
                                    </div>


                                    <div class="w-full border-b-2 border-gray-300 inputval mb-8">
                                        <input type="text" name="city" class="w-full bg-transparent focus:outline-none p-2 val"
                                            placeholder="City">
                                    </div>
