                                ...
                                <div
                                    ...
                                    <div class="w-full h-auto">
                                        ...
                                        <div class="w-full border-b inputval mb-2">
                                            ...
                                            <input type="text" name="regname" class="w-full border-2 border-gray-400 focus:outline-none p-4 val"
                                                placeholder="Your Name">
                                        </div>

                                        <div class="w-full border-b inputval mb-2">
                                            <label for="">Email</label>
                                            <input type="text" name="regemail" class="w-full border-2 border-gray-400 focus:outline-none p-4 val"
                                        ...
                                        <div class="w-full border-b inputval mb-2">
                                            ...
                                            <input type="password" name="regpassword"
                                                class="w-full border-2 border-gray-400 focus:outline-none p-4 val" placeholder="Password">
                                        </div>
