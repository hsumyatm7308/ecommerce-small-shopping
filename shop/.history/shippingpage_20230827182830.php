                                    ...
                                    <div class="w-full border border-2 p-5">
                                        ...
                                        <form action="" method="post">
                                            ...
                                            <div
                                                ...
                                                <input type="checkbox" name="free[]" value="free" id="checkbox1">
                                            ...
                                            <div
                                                ...
                                                <input type="checkbox" name="free[]" value="fast" id="checkbox2">
                                                    <label for="" class="">
                                            ...
                                            <div class="grid grid-cols-4  px-3 py-2">
                                                ...
                                                <input type="checkbox" name="free[]" value="free3" id="checkbox3">
                                                    <label for="" class="">
