        ...
        <div class="mr-10">
          ...
          if (isset($_GET['items'])) {
            ...
            if ($itemId === $row['id']) {
              ...
              <div class="w-96  bg-green-100 flex justify-between items-center mt-3 p-2">
                ...
                <span>Item added to the cart</span></span>

                <a href="shopcartpage.php" class="text-indigo-500 mr-4 hover:text-indigo-800">
                  View cart
                </a>
              </div>
