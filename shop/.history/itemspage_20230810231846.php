      ...
      <div>
        ...
        <div class="mr-10">
          ...
          if (isset($_GET['items'])) {
            ...
            if ($itemId === $row['id']) {
              ...
              <div class="flex items-center mt-3">
               ...
               <div class="  flex  items-center mt-3">
                   <a href="" class="w-32 text-gray-100 bg-gray-500 flex justify-center items-center drop-shadow-lg p-1" id="addtocartbtn">Add to cart</a>
              </div>
          ...
          <script class="text/javascript">
            ...
            $(addtocartbtn).on('click',addtocartbtn)
