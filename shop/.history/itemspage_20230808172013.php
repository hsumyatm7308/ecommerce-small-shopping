...
<script>
  $("#submitreview").click(function () {
    var username = $('#username').val();
    var userreview = $('#userreview').val();
    var rating_data = $('.submit-star.text-yellow-500').last().data('rating'); // Get the last selected star rating

    // Make sure to include CSRF token (if used in your application)
