                ...
                <div class="w-80">
                    ...
                    <div class="h-auto mb-5">
                        ...
                        <form action="" method="get">
                            ...
                            <button type="text" id="updateprice" name="type" class="w-24 border border-2 rounded m-1 p-1">UPDATE</button>
...
<script>
    ...
    function handleCheckboxClickprice() {
        ...
        if (updateprice.checked) {
            window.location.href = `index.php?type=p?startprice=${$startprice}&endprice=${$endprice}?pricequery=1`;
        } else {
            window.location.href = "index.php";
        }
    }
    ...
    if (typeParam === "p") {
        updateprice.checked = true;
    } else {
        updateprice.checked = false;
    }
</script>