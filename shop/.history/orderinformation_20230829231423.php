...
<script>
    ...
    console.log(parseFloat(getsubtotal))

    var numericPart = originalString.replace(/[^0-9.]/g, "");

// If you want to remove the decimal point as well and get an integer, you can parse it
var numericValue = parseFloat(numericPart);

// Output the numeric part
...
<?php
// Check if the 'subtotal' value is in the POST request
