...
<div class="flex justify-center items-center mt-10 p-10">
    ...
    if (isset($_GET['womenpage']) && $_GET['womenpage'] > 1) {
        ?> <a href="?womenpage=<?php echo $_GET['womenpage'] - 1 ?>" class="text-red-500 border px-2 py-1 mr-10">Prev</a>
        <?php
    } else {
    ...
    for ($x = 1; $x <= $totalpages; $x++) {
        ...
        echo '<a href="womenfrg.php?womenpage=' . $x . '" class="w-6 h-7 border p-1 m-1 flex justify-center items-center bg-red-500">' . $x . '</a>';
