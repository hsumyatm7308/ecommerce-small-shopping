            ...
            <div>
                <ul class="flex justify-center items-center">
                    ...
                    <form action="" method="post" class="flex justify-center items-center">
                        ...
                        if (isset($_POST['asc'])) {
                            echo '<li class="mr-5">
                                <button type="submit" name="asc" class=" border border-t-transparent border-l-transparent border-r-transparent border-b-gray-500 rounded-full p-1">Ascending price</button>
                            </li>';
                        }else{
                            echo '<li class="mr-5">
