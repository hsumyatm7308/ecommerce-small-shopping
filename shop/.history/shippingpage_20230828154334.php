                                ...
                                <div class="w-full border border-2 p-5 ">
                                    <div class="grid grid-cols-4 border-b border-b-solid border-b-gray-300 px-3 py-2">
                                        ...
                                        <div class="flex justify-between items-center">
                                            ...
                                            <span class="font-semibold changebtn ml-28">Change</span>
                                            <input type="submit" name="submit"
                                                class="font-semibold text-red-500 changeinput mr-5 hidden " value="Update">
                                    ...
                                    <div class="grid grid-cols-4  p-3">
                                        ...
                                        <div class="flex justify-between items-center">
                                            ...
                                            <span class="font-semibold changebtn ml-28 mr-2">Change</span>
