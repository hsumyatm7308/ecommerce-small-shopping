            ...
            if ($itemId === $row['id']) {
              ...
              <input type="hidden" name="id" value="{$row['id']}">
               ...
               <div class="  flex  items-center mt-3">
                   ...
                   <button type="button" name="addtocart" class="w-32 text-gray-100 bg-gray-500 flex justify-center items-center drop-shadow-lg p-1 hover:drop-shadow-[0_7px_7px_#d4d4d8] hover:opacity-100" id="addtocart" >Add to cart</button>
              </div>
