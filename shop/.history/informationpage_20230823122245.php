                        ...
                        <form action="" method="post" class="w-[80%]">
                            ...
                            <div class="w-full">
                                ...
                                <div class="w-full border border-2 p-5">
                                    ...
                                    <div class="w-full border-b inputval mb-2">
                                        <input type="password" name="customeraddress"
                                            class="w-full focus:outline-none p-4 val" placeholder="Password">
                                    </div>

                                    <div class="w-full">
                                        <button class="w-full focus:outline-none p-4">Create your account <a href=""
                                                class="text-indigo-500"> Register</a> || <a href="" class="text-indigo-500">As a guest</a></button>
                                    </div>
