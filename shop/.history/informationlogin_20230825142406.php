            ...
            if ($email === '' || $password === '' ) {
                ...
                if ($email && $password) {
                    try {
                        ...
                        $stmt = $conn->prepare('SELECT email,password FROM customerinfo WHERE email =:email AND password=:password WHERE temporary_id');
                        ...
                        if ($stmt->rowCount() === 0) {
                            ...
                            $_SESSION['loginpassword'] = $bindpassword;
