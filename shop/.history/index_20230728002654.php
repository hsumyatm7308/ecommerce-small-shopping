            ...
            <div class=" flex  justify-end ">
                <div class="w-80">
                    ...
                    <div>
                        ...
                        <form id="unisexForm" action="index.php" method="get">
...
function handleCheckboxClick() {
    ...
    if (checkbox.checked) {
      window.location.href = "index.php?type=on";
    } else {
...
Now, when you click on the "Unisex" checkbox in the "unisexForm" form, the JavaScript code will handle the click event and update the checkbox state on the index.php page accordingly. If you click the "Unisex" checkbox in "unisexForm," it will automatically check the checkbox on index.php, and the "type" parameter will be correctly set in the URL.
