      ...
      <div>
        ...
        <div>
          ...
          if (isset($_GET['items'])) {
            ...
            if ($itemId === $row['id']) {
              echo '<h1 class="text-3xl">' . $row['perfume_name'] . ' by ' . $row['brand_name'] . ' EDT 3.3 OZ ' . $row['mili'] . ' spray for ' . $row['category_name'] . '</h1>';
              echo '<p class="mt-5 mb-3">Avaliable <span>(In stock)</span></p>';
              echo '<span class="text-green-600 font-semibold text-3xl">$34.98</span>'
            }
          }
          ?>
