<div class="col-span-2 w-[80%] h-[100vh]   ">
    <h1 class="text-2xl mt-16">Order Summary</h1>

    <div class="w-full min-h-[300px] bg-gray-200 mt-10 mb-8">
        ...
        <div class="w-full h-auto  px-5 mt-5 ml-4">
            ...
            <div class="flex justify-end mt-3 ml-4">
                <div class="w-[100%] grid grid-cols-3">
                    <div class="col-span-2 flex justify-start items-center">
