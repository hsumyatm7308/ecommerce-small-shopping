                ...
                <span class="text-xl text-yellow-500 font-semibold"><span id="averagerating">
                    ...
                    if (isset($_GET['items'])) {
                      ...
                      try {
                        ...
                        echo '<div class="w-[' . $averageStarRatingPercentage . '%] h-3 bg-yellow-500 rounded-tl rounded-bl progress" id="five-star-progresss"></div>';

                        // Display stars with yellow color based on the average rating
                        for ($i = 1; $i <= 5; $i++) {
                          echo '<svg xmlns="http://www.w3.org/2000/svg" fill=" ' . (($i <= $averageRating) ? 'yellow' : 'gray') . '" viewBox="0 0 24 24" stroke-width="1.5"
