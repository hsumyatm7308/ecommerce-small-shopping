                                        ...
                                        <form action="" method="post">
                                            <div
                                                ...
                                                <div class="col-span-3">
                                                    <input type="radio" name="shipcost" value="free" id="shipcost_free"
                                                        class="mycheckbox">
                                            ...
                                            <div
                                                ...
                                                <div class="col-span-3">
                                                    <input type="radio" name="shipcost" value="fast" id="shipcost_fast">
                                            ...
                                            <div class="grid grid-cols-4 px-3 py-2">
                                                <div class="col-span-3">
                                                    <input type="radio" name="shipcost" value="fastest"
                                                        id="shipcost_fastest">
                                            ...
                                            <button type="submit" name="ctnshipmethod">Submit</button>
                                        </form>
...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    if (isset($_POST['ctnshipmethod'])) {
        ...
        if (isset($_POST['shipcost'])) {
            ...
            echo "Selected Shipping Option: " . $selectedValue;
        } else {
