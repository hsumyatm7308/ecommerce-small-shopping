...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    if (isset($_POST['action']) && $_POST['action'] === 'update') {
        ...
        $checkstmt = $conn->prepare("SELECT perfumeprice FROM addtocart WHERE perfume_id = :id AND temporaryid = :tempid");
        ...
        $updatestmt = $conn->prepare("UPDATE addtocart SET quantity = :qty, totalprice = :priceval WHERE perfume_id = :id AND temporaryid = :tempid");
