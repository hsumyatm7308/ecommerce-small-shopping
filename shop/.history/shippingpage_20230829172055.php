...
try {
    ...
    $contact->bindParam('temp', $temp['id']);
    $contact->execute();
    ...
    <section class="p-10">
        ...
        <div class="grid grid-cols-6">
            ...
            <div class="col-span-4 w-full flex justify-start items-center flex-col">
                ...
                <h1 class="text-3xl font-semibold self-start ml-24 mt-10">Shipping</h1>
                <!-- head  -->
                ...
                <section class="w-full flex justify-center ">
                    ...
                    <div class="w-full min-h-[700px] flex justify-center items-center flex-col">
                        ...
                        <form action="" method="post" class="w-[80%]">
                            ...
                            <div class="w-full">
                                <div class="bg-[#ffff] mt-10 rounded shadow mb-10 px-10 pt-10 py-20 ">

                                    <h1 class="self-start  text-lg mb-5">Address</h1>
                                    ...
                                    <div class="w-full border border-2 border-gray-400 p-5 mt-3">


                                        <div
                                            class="grid grid-cols-4 border-b border-b-solid border-b-gray-400 px-3 py-2">
                                            <div class="p-2">
                                            ...
                                            <div class="flex justify-between items-center">
                                                <button class="text-darkblue-500 ml-5 hidden cancle">Cancle</button>

                                                <span class="font-semibold changebtn ml-24 p-2">Change</span>
                                                <input type="submit" name="submit"
                                                    class="font-semibold text-red-500 changeinput mr-5 hidden "
                                                    value="Update">
                                        ...
                                        <div class="grid grid-cols-4  p-3">
                                            ...
                                            <div class="col-span-2 flex justify-start items-center">
                                                ...
                                                <input type="hidden" name="addressval"
                                                    class="p-2 border border-2 border-b-gray-300 rounded  inputtype"
                                    ...
                                    <div class="mt-10">
                                        <h1 class="mb-5 text-lg">Shipping method</h1>
                                        <!-- <hr class="border-b border-dashed border-gray-400 mb-5"> -->

                                        <div
                                            class="w-full h-[300px] flex justify-center items-center flex-col border border-2 border-gray-400 p-5 shipmethodctn">


                                            <div
                                                class="grid grid-cols-4 border-b border-b-solid border-b-gray-400 px-3 py-5">
                                            ...
                                            <div class="grid grid-cols-4 px-3 py-5">
                                                <div class="col-span-3">
                                ...
                                <div class="w-full flex justify-between items-center mt-10">
                                    <div class="flex justify-center items-center">
                                        ...
                                        <a class="text-[#1c2e7e] font-semibold">Return to Information</a>
                                    </div>
    ...
    <script>
        ...
        for (let i = 0; i < changebtn.length; i++) {
            changebtn[i].addEventListener('click', function () {
                ...
                cancle[i].classList.remove('hidden');
                // console.log();
            });

            cancle[i].addEventListener('click', function () {
                value[i].classList.remove('hidden');

                changeinput[i].classList.add('hidden');

                this.classList.remove('hidden');
                inputtype[i].type = "hidden";

                cancle[i].classList.add('hidden');
            })
        }
...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    if (isset($_POST['ctnshipmethod'])) {
        if (isset($_POST['shipcost'])) {
            ...
            $costval = intval($selectedvalue);

            $insertcost = $conn->prepare("UPDATE shippingaddress SET shipcost = :cost WHERE temporaryid = :temp");
            $insertcost->bindParam(":cost", $costval);
            $insertcost->bindParam(":temp", $temp['id']);
            $insertcost->execute();
...
if (isset($_POST['submit'])) {
    ...
    $addressvalue = $_POST['addressval'];
    echo $emailvalue, $addressvalue;
    ...
    $contact = $conn->prepare("UPDATE customerinfo SET email = :email WHERE temporary_id = :tempid");
    $contact->bindParam(':email', $emailvalue);

    $contact->bindParam(':tempid', $temp['id']);
    $contact->execute();

    $address = $conn->prepare("UPDATE shippingaddress SET address = :address WHERE temporaryid = :tempid");
    $address->bindParam(':address', $addressvalue);

    $address->bindParam(':tempid', $temp['id']);
    $address->execute();
