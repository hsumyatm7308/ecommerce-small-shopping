      ...
      <div>
        ...
        <div class="mr-10">
          ...
          if (isset($_GET['items'])) {
            ...
            if ($itemId === $row['id']) {
              echo <<<HTML
              <h1 data-perfume-name="<?php echo $row['perfume_name']; ?>" data-brand-name="<?php echo $row['brand_name']; ?>"  class="text-3xl">{$row['perfume_name']} by {$row['brand_name']} EDT 3.3 OZ {$row['mili']} spray for {$row['category_name']}</h1>
