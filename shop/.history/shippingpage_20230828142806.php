                            ...
                            <div class="w-full">
                                <div class="w-full border border-2 p-5 ">
                                    <div class="grid grid-cols-4 border-b border-b-solid border-b-gray-300 px-3 py-2">
                                        <div class="">
                                            <p class="text-gray-400 p-2">Contact</p>
                                        </div>
                                        <div class="col-span-2">
                                            ...
                                            <input type="hidden" class="p-2 inputtype" value="<?php echo $row['email'] ?>">
                                        </div>



                                        <div class="flex justify-center items-center">
                                            <span class="font-semibold changebtn p-2">Change</span>
                                        </div>
                                    ...
                                    <div class="grid grid-cols-4  p-3">
                                        ...
                                        <div class="col-span-2">
                                            ...
                                            <input type="hidden" class="p-2 border border-2 border-b-gray-300 rounded inputtype" value="<?php echo $rowaddr['address'] ?>" autofocus>
    ...
    <script>
        ...
        for (let i = 0; i < changebtn.length; i++) {
            changebtn[i].addEventListener('click', function () {
                ...
                this.innerHTML = `<button type="submit" class="font-semibold changebtn">Update</button>`;
