                  ...
                  <?php
                    ...
                    if (isset($_GET['items'])) {
                      ...
                      try {
                        ...
                        $rating = $conn->prepare("SELECT * FROM reviewtable WHERE perfume_id = :id AND userrating = :rating");
                        $rating->bindParam(':id', $id);
                        $rating->bindParam(':rating', $rating);
                        $rating->execute();
                       
                        $stmt->execute();

                        $totalrowcount = $stmt->rowCount();
                        $fivestar = $rating->rowCount();
                        echo $rating->rowCount();
