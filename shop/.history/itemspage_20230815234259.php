...
<body class="w-srceen overflow-x-hidden">
  ...
  <script class="text/javascript">
    $(document).ready(function () {
      ...
      $("#addtocart").click(function () {
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            if (data === "already_added") {
              setAlertMessage("Item already added to cart", "error");
            } else if (data === "item_added") {
              setAlertMessage("Item added to cart", "success");
            }
        ...
        function setAlertMessage(message, type) {
          // Store the alert message and type in a session or cookie
          sessionStorage.setItem("customAlertMessage", message);
          sessionStorage.setItem("customAlertType", type);
        }
    ...
    var customAlertMessage = sessionStorage.getItem("customAlertMessage");
    var customAlertType = sessionStorage.getItem("customAlertType");

    if (customAlertMessage && customAlertType) {
        showCustomAlert(customAlertMessage, customAlertType);
        sessionStorage.removeItem("customAlertMessage");
        sessionStorage.removeItem("customAlertType");
    }
});

function showCustomAlert(message, type) {
    // Implement your custom alert display logic here, similar to the previous example
}
