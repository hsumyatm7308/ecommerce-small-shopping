        ...
        <div class="mr-10">
          ...
          <div class="mt-5">
            <div class="flex items-center">
              ...
              <span id="writereview" class="m-3 cursor-pointer">Write review <span>(<span id="totalreview">3</span>
                  Reviews)</span></span>
            </div>
            <div class="mb-3">
              <div>
      ...
      $("#submitreview").click(function () {
        ...
        if (!username || !userreview) {
          ...
          $.ajax({
            ...
            method: "POST",
            data: {
              "rating_data": rating_data, // Fixed typo in this line
              "username": username,
              "userreview": userreview
            },
            success: function (data) {
              $(modal).css("display", 'none');
              load_rating_data(); // Make sure this function is defined and handles the data loading.
              alert(data);
            },
