                                ...
                                <div class="w-full border border-2 p-5 ">
                                    <div class="grid grid-cols-4 border-b border-b-solid border-b-gray-300 px-3 py-2">
                                        ...
                                        <div class="flex justify-between items-center">
                                            <button class="text-darkblue-500 ml-5">Cancle</button>

                                            <span class="font-semibold changebtn mr-5">Change</span>
                                    ...
                                    <div class="grid grid-cols-4  p-3">
                                        ...
                                        <div class="flex justify-between items-center">
                                            <button class="text-darkblue-500 ml-5 hidden">Cancle</button>
