                    ...
                    <div>
                        ...
                        <!-- <form action="unisex-type.php" method="post"> -->
                            <a href="unisex-type.php" class="flex items-center">
                                ...
                                <label type="submit" for="type"> Unisex</label>
...
<script>
    ...
    const link = document.querySelector('a.flex.items-center');
    ...
    link.addEventListener('click', function(event) {
        ...
        if (checkbox.checked) {
            // If checked, navigate to the specified URL (unisex-type.php)
            window.location.href = 'unisex-type.php';
        }
    });
</script>