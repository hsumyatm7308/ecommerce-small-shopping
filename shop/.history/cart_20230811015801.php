...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (isset($_POST["quantity"])) {
        ...
        $id = $_GET['items'];
        $perfumeName = $_POST["perfumeName"]; // Check this key
        $brandName = $_POST["brandName"];     // Check this key
        $imgurl = $_POST["imgurl"];
        
        echo $quantity, $id, $perfumeName, $brandName, $imgurl;
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (isset($_POST["quantity"])) {
        ...
        try {
            ...
            // $cartstmt->bindParam(':perfumname', $id);
            // $cartstmt->bindParam(':perfumeprice', $id);
