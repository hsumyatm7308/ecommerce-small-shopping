    ...
    <section class="">
        ...
        <div class="grid grid-cols-6">
            ...
            <div class="col-span-4 w-full flex justify-start items-center flex-col">
                ...
                <h1 class="self-start ml-[100px] mt-24 text-lg">Address</h1>
                        ...
                        <form action="" method="post" class="w-[80%]">
                            <div class="w-full">
                                <div class="w-full border border-2 border-gray-400 p-5 ">
                                    ...
                                    <div class="grid grid-cols-4 border-b border-b-solid border-b-gray-400 px-3 py-2">
                                        <div class="p-2">
                                ...
                                <div class="mt-10">
                                    ...
                                    <div class="w-full h-[300px] flex justify-center items-center flex-col border border-2 border-b-gray-400 p-5 shipmethodctn">
                                        ...
                                        <div
                                            class="grid grid-cols-4 border-b border-b-solid border-b-gray-300 px-3 py-5">
                                            <div class="col-span-3">
