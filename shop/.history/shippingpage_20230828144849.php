                                ...
                                <div class="w-full border border-2 p-5 ">
                                    <div class="grid grid-cols-4 border-b border-b-solid border-b-gray-300 px-3 py-2">
                                        ...
                                        <div class="flex justify-center items-center">
                                            ...
                                            <input type="hidden" name="submit" class="font-semibold text-red-500 changebtn" value="Update">
    ...
    <script>
        ...
        for (let i = 0; i < changebtn.length; i++) {
            changebtn[i].addEventListener('click', function () {
                ...
                this.innerHTML = `<button type="submit" name="submit" class="font-semibold text-red-500 changebtn">Update</button>`;
