...
<?php while ($row = $stmt->fetch()): ?>
    ...
    <div id="" class="cart-item grid grid-cols-6 justify-center items-center border-b mb-4">
        <div class="col-span-2 flex justify-center items-center">
            ...
            <span class="ml-10"><?= $row['perfume_name'] ?> by <?= $row['brand_name'] ?> EDT 3.3 OZ
               <?= $row['mili'] ?> spray for Women</span>
        </div>
            ...
            <div class="flex justify-center items-center p-1">
                <div class="item flex justify-center items-center p-1">
                    <div class="flex items-center">
                        <span id="decrease-' . $id . '" class="bg-gray-100 border px-2 py-1 m-1 decrease">
                        ...
                        <span
                            ...
                            <input type="text" class="w-8 bg-gray-100 focus:outline-none valueInput"
                                value="' . $quantity . '" style="text-align:center;">
                        </span>

                        <span id="increase-' . $id . '" name="increase" class="bg-gray-100 border px-2 py-1 m-1 increase">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-4 h-4">
        ...
        <div class="flex justify-center items-center">
            ...
            <input type="text" id="totalprice-' . $id . '" class="w-20 p-1 focus:outline-none totalprice"
                value="$' . number_format($quantity * $price, 2) . '" readonly>
        </div>
