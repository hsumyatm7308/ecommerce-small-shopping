...
<body class="">
    ...
    <section class="">
        ...
        <div class="grid grid-cols-6">
            ...
            <div class="col-span-2 w-[80%] min-h-[10vh] bg-gray-200 mt-20">
    ...
    <div class="w-full h-auto  px-5 mt-5">
        <div class="flex justify-end ">
            <div class="w-[80%] grid grid-cols-3">
                ...
                <div class="col-span-1 flex justify-center items-center mr-10">
        ...
        <div class="flex justify-end mt-3">
            <div class="w-[80%] grid grid-cols-3">
                <div class="col-span-2 flex justify-start items-center">
                    <h1 class="mr-10">Shiping Cost</h1>
                </div>
                <div class="col-spans-1 flex justify-center items-center mr-10">
