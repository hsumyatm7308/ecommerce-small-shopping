                        ...
                        <form action="" method="post" class="w-[80%]">
                            ...
                            <div class="w-full">
                                ...
                                <div
                                    ...
                                    <h1 class="text-lg self-start mb-5 mt-5">Log In</h1>
                                    ...
                                    <div class="w-full flex justify-end items-center mt-7 mb-5">
                                        <button class=" focus:outline-none p-4">
                                            <a href="informationregister.php" id="registerbtn"
                                                class="text-indigo-500 font-semibold registerbtn"> Register</a>
