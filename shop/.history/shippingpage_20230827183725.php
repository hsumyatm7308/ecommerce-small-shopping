                    ...
                    <div class="w-full min-h-[700px] flex justify-center items-center flex-col">
                        ...
                        <form action="" method="post" class="w-[80%]">
                                        ...
                                        <form action="" method="post">
                                            ...
                                            <div
                                                ...
                                                <div class="col-span-3">
                                                    ...
                                                    <input type="radio" name="free" value="free" id="myCheckbox"
                                                        class="mycheckbox">
                                            ...
                                            <div
                                                ...
                                                <div class="col-span-3">
                                                    ...
                                                    <input type="radio" name="fast12" value="fast" class="mycheckbox">
                                                    <label for="" class="">
                                            ...
                                            <div class="grid grid-cols-4  px-3 py-2">
                                                <div class="col-span-3">
                                                    ...
                                                    <input type="radio" name="fastest25" value="fastest"
                                                        class="mycheckbox">
                                                    <label for="" class="">
                            ...
                            <div class="w-[80%] flex justify-between items-center mt-5">
                                ...
                                <div class="">
                                    <form action="" method="post">
                                        <button type="submit" name="ctnship"
