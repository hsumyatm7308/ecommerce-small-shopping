            ...
            <div class=" flex  justify-end ">
                <div class="w-80">
                    ...
                    <div>
                        ...
                        <form id="unisexForm" action="allfrg.php" method="get">
...
<script>
  document.getElementById("type").addEventListener("change", function() {
    document.getElementById("unisexForm").submit();
  });
</script>
In this code, we've replaced the anchor tag (<a>) with a form element (<form>) to submit the data. The JavaScript function now listens for a change in the checkbox state, and when it changes (becomes checked), it will automatically submit the form.
...
if (isset($_GET['type']) && $_GET['type'] === 'on') {
    try {
        // Perform your database query to fetch the "Unisex" category data here
        // ...
...
?>
In allfrg.php, we check if the "type" parameter is present in the URL and if its value is set to "on." This is because checkboxes send the value "on" when checked. If the condition is met, you can perform your database query to fetch the data for the "Unisex" category.

With these changes, when you click on the "Unisex" label or checkbox, the form will automatically submit the data to allfrg.php with the "type" parameter set to "on." In allfrg.php, the "Unisex" category data should be displayed accordingly.
