                        ...
                        <form action="womenfrg.php" method="get">
                            ...
                            <script>
                                function updatePrice() {
                                    ...
                                    var updateURL = "womenfrg.php?startprice=" + startprice + "&endprice=" + endprice + "&price=1";
...
<script>
    ...
    function handleCheckboxClick() {
        ...
        if (checkbox.checked) {
            window.location.href = "womenfrg.php?page=1&type=on&unisexquery=1";
        } else {
    ...
    function handleCheckboxClickwomen() {
        ...
        if (fcheckbox.checked) {
            window.location.href = "womenfrg.php?page=1&type=fon&womenquery=1";
        } else {
            window.location.href = "womenfrg.php";
        }
    }
