                ...
                <div class="w-80">
                    ...
                    <div class="h-auto mb-5">
                        ...
                        <form action="" method="get">
                            ...
                            <button type="text" id="updateprice" name="updateprice" class="w-24 border border-2 rounded m-1 p-1">UPDATE</button>
...
<script>
    ...
    function handleCheckboxClickprice() {
        ...
        if (updateprice.checked) {
            window.location.href = `index.php?startprice=${$startprice}&endprice=${$endprice}?pricepage=1`;
        } else {
            window.location.href = "index.php";
        }
    }
