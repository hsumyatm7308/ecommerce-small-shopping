...
<body>
                                        ...
                                        <form action="" method="post">
                                            ...
                                            <div
                                                ...
                                                <div class="col-span-3">
                                                    <input type="checkbox" name="free[]" value="0" id="checkbox1">
                                                    <label for="checkbox1">
                                            ...
                                            <div
                                                ...
                                                <div class="col-span-3">
                                                    <input type="checkbox" name="free[]" value="12" id="checkbox2">
                                                    <label for="checkbox2">
                                            ...
                                            <div class="grid grid-cols-4 px-3 py-2">
                                                <div class="col-span-3">
                                                    <input type="checkbox" name="free[]" value="25" id="checkbox3">
                                                    <label for="checkbox3">
                                            ...
                                            <button id="checkButton">Check Checked Checkboxes</button>
    ...
    <script>
        ...
        checkButton.addEventListener("click", function () {
            // Get all checkboxes with the name "free[]"
            var checkboxes = document.querySelectorAll('input[name="free[]"]');

            // Create an array to store the checked values
            var checkedValues = [];

            // Loop through the checkboxes and check if each is checked
