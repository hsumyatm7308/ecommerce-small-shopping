    ...
    $(document).ready(function () {
      ...
      function load_rating_data() {
        $.ajax({
          ...
          success: function (data) {
            // Update average rating and total review count
            $('#averagerating').text(data.averagerating);
            $('#totalreview').text(data.totalreview);

            // Update star ratings based on average rating
            var countstar = 0;
            ...
            $('#four_star_progress').css('width', (data.fourstarreview / data.totalreview) * 100 + '%');
            ...
            // Update review content if available
            if (data.reviewdata.length > 0) {
              var html = '';
              for (var count = 0; count < data.reviewdata.length; count++) {
                // Generate HTML for each review entry
                // ...

                // Append the HTML to the review_content element
                // ...
