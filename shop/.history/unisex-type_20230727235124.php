            ...
            <div class=" flex  justify-end ">
                <div class="w-80">
                    ...
                    <div>
                        ...
                        <form id="unisexForm" action="unisex-type.php" method="post">
                            <label for="type" class="flex items-center" aria-checked="true">
                                <input type="checkbox" id="type" name="type" class="m-1" checked>
                                Unisex
                            </label>
                        </form>
...
require_once "unisex-typebk.php"
