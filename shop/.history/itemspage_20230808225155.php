                ...
                <span class="text-xl text-yellow-500 font-semibold"><span id="averagerating">
                    ...
                    if (isset($_GET['items'])) {
                      ...
                      try {
                        ...
                        // Display filled stars and empty stars based on the average rating
                        for ($i = 1; $i <= 5; $i++) {
                          echo '<div class="w-4 h-4 mainstar" style="background-color: ' . (($i <= $averageRating) ? 'yellow' : 'transparent') . ';"></div>';
                        }
