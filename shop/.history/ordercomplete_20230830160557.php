...
<body class="bg-gray-100">
    ...
    <section class="w-full flex justify-center items-center">
        <div class="w-[50%]">
            ...
            <div class="w-full min-h-52 mt-10 bg-[#ffffff] p-14 rounded shadow flex justify-center items-center flex-col">

                <?php require_once "orderinformation.php"; ?>

                <h1 class="text-xl font-semibold">Thank you for your order!</h1>
