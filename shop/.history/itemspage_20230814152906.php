        ...
        <div class="mr-10">
          ...
          if (isset($_GET['items'])) {
            ...
            if ($itemId === $row['id']) {
              ...
              <h1 class="text-3xl" data-perfume-name="{$row['perfume_name']}" data-brand-name="{$row['brand_name']}" data-category-name="{$row['category_name']}">
               {$row['perfume_name']} by {$row['brand_name']} EDT 3.3 OZ {$row['mili']} spray for {$row['category_name']}</h1>
              ...
              <input type="hidden" name="id" value="{$row['id']}">
               ...
               <div class="  flex  items-center mt-3">
                   ...
                   <button type="button" name="addtocart" class="w-32 text-gray-100 bg-gray-500 flex justify-center items-center drop-shadow-lg p-1" id="addtocart" >Add to cart</button>
              </div>
  ...
  <script class="text/javascript">
    $(document).ready(function () {
      ...
      $("#addtocart").click(function () {
        ...
        var perfumeName = $("h1").data("perfume-name");
        var brandName = $("h1").data("brand-name");
        var categoryName = $("h1").data("category-name");

        console.log("Perfume Name:", perfumeName);
