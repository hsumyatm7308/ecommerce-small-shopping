...
<script>
    function handleLetterClick(letter) {
        ...
        for (const letter of updatedLetters) {
            ...
            outerSpan.classList.add( 'text-xs','text-stone-400','capitalize' ,'border','rounded','p-1', 'm-1','flex' ,'justify-center' ,'items-center'); 

            text-xs text-stone-500 font-sans mx-1
