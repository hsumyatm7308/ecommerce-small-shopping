        ...
        <div class="mr-10">
          ...
          if (isset($_GET['items'])) {
            ...
            if ($itemId === $row['id']) {
              ...
              <div class="flex items-center mt-3">
               ...
               <div class="  flex  items-center mt-3">
                   <a href="" class="w-32 text-gray-100 bg-gray-500 flex justify-center items-center drop-shadow-lg p-1">Add to cart</a>
              </div>
          ...
          <script>
            ...
            document.addEventListener("DOMContentLoaded", () => {
              ...
              // Attach an event listener to the input field for value changes
            ...
            function sendDataToServer(value) {
              // Replace 'process.php' with your server-side script URL
              fetch("shopcartpage.php", {
                method: "POST", // You can use "GET" or "POST" as needed
              
                body: `value=${encodeURIComponent(value)}`, // Send the value as a parameter
              })
